...
.field private callFactory:Lk/f$a;
    .annotation runtime Ljavax/annotation/Nullable;
    .end annotation
.end field
...
.method constructor <init>(Lretrofit2/Retrofit;)V
    ...
    iget-object v0, p1, Lretrofit2/Retrofit;->callFactory:Lk/f$a;

    iput-object v0, p0, Lretrofit2/Retrofit$Builder;->callFactory:Lk/f$a;

    iget-object v0, p1, Lretrofit2/Retrofit;->baseUrl:Lk/x;

    iput-object v0, p0, Lretrofit2/Retrofit$Builder;->baseUrl:Lk/x;
...
.method public baseUrl(Ljava/lang/String;)Lretrofit2/Retrofit$Builder;
    ...
    invoke-static {p1}, Lk/x;->h(Ljava/lang/String;)Lk/x;

    move-result-object p1

    invoke-virtual {p0, p1}, Lretrofit2/Retrofit$Builder;->baseUrl(Lk/x;)Lretrofit2/Retrofit$Builder;
...
.method public baseUrl(Lk/x;)Lretrofit2/Retrofit$Builder;
    .locals 3
    ...
    invoke-virtual {p1}, Lk/x;->n()Ljava/util/List;
    ...
    iput-object p1, p0, Lretrofit2/Retrofit$Builder;->baseUrl:Lk/x;
...
.method public build()Lretrofit2/Retrofit;
    ...
    iget-object v0, p0, Lretrofit2/Retrofit$Builder;->baseUrl:Lk/x;

    if-eqz v0, :cond_2

    iget-object v0, p0, Lretrofit2/Retrofit$Builder;->callFactory:Lk/f$a;
    ...
    iget-object v3, p0, Lretrofit2/Retrofit$Builder;->baseUrl:Lk/x;
    ...
    invoke-direct/range {v1 .. v7}, Lretrofit2/Retrofit;-><init>(Lk/f$a;Lk/x;Ljava/util/List;Ljava/util/List;Ljava/util/concurrent/Executor;Z)V
...
.method public callFactory(Lk/f$a;)Lretrofit2/Retrofit$Builder;
    .locals 1
    ...
    iput-object p1, p0, Lretrofit2/Retrofit$Builder;->callFactory:Lk/f$a;
...
.method public client(Lk/b0;)Lretrofit2/Retrofit$Builder;
    .locals 1
    ...
    invoke-virtual {p0, p1}, Lretrofit2/Retrofit$Builder;->callFactory(Lk/f$a;)Lretrofit2/Retrofit$Builder;
