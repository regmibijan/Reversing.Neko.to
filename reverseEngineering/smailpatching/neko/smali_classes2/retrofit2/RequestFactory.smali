...
.field private final headers:Lk/w;
    .annotation runtime Ljavax/annotation/Nullable;
    .end annotation
.end field
...
.method constructor <init>(Lretrofit2/RequestFactory$Builder;)V
    ...
    iget-object v0, v0, Lretrofit2/Retrofit;->baseUrl:Lk/x;

    iput-object v0, p0, Lretrofit2/RequestFactory;->baseUrl:Lk/x;
    ...
    iget-object v0, p1, Lretrofit2/RequestFactory$Builder;->headers:Lk/w;

    iput-object v0, p0, Lretrofit2/RequestFactory;->headers:Lk/w;

    iget-object v0, p1, Lretrofit2/RequestFactory$Builder;->contentType:Lk/z;

    iput-object v0, p0, Lretrofit2/RequestFactory;->contentType:Lk/z;
...
# virtual methods
.method create([Ljava/lang/Object;)Lk/d0;
    .locals 12
    ...
    iget-object v5, p0, Lretrofit2/RequestFactory;->baseUrl:Lk/x;

    iget-object v6, p0, Lretrofit2/RequestFactory;->relativeUrl:Ljava/lang/String;

    iget-object v7, p0, Lretrofit2/RequestFactory;->headers:Lk/w;

    iget-object v8, p0, Lretrofit2/RequestFactory;->contentType:Lk/z;
    ...
    invoke-direct/range {v3 .. v11}, Lretrofit2/RequestBuilder;-><init>(Ljava/lang/String;Lk/x;Ljava/lang/String;Lk/w;Lk/z;ZZZ)V
    ...
    :cond_1
    invoke-virtual {v2}, Lretrofit2/RequestBuilder;->get()Lk/d0$a;
    ...
    invoke-virtual {p1, v0, v1}, Lk/d0$a;->h(Ljava/lang/Class;Ljava/lang/Object;)Lk/d0$a;
