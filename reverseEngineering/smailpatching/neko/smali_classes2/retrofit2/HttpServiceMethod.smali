...
# direct methods
.method constructor <init>(Lretrofit2/RequestFactory;Lk/f$a;Lretrofit2/Converter;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p2, p0, Lretrofit2/HttpServiceMethod;->callFactory:Lk/f$a;
...
.method static parseAnnotations(Lretrofit2/Retrofit;Ljava/lang/reflect/Method;Lretrofit2/RequestFactory;)Lretrofit2/HttpServiceMethod;
    ...
    iget-object v6, p0, Lretrofit2/Retrofit;->callFactory:Lk/f$a;

    if-nez v4, :cond_4

    new-instance v0, Lretrofit2/HttpServiceMethod$CallAdapted;

    invoke-direct {v0, p2, v6, v3, v5}, Lretrofit2/HttpServiceMethod$CallAdapted;-><init>(Lretrofit2/RequestFactory;Lk/f$a;Lretrofit2/Converter;Lretrofit2/CallAdapter;)V
    ...
    invoke-direct {v0, p2, v6, v3, v5}, Lretrofit2/HttpServiceMethod$SuspendForResponse;-><init>(Lretrofit2/RequestFactory;Lk/f$a;Lretrofit2/Converter;Lretrofit2/CallAdapter;)V
    ...
    invoke-direct/range {v0 .. v5}, Lretrofit2/HttpServiceMethod$SuspendForBody;-><init>(Lretrofit2/RequestFactory;Lk/f$a;Lretrofit2/Converter;Lretrofit2/CallAdapter;Z)V
...
.method final invoke([Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget-object v2, p0, Lretrofit2/HttpServiceMethod;->callFactory:Lk/f$a;

    iget-object v3, p0, Lretrofit2/HttpServiceMethod;->responseConverter:Lretrofit2/Converter;

    invoke-direct {v0, v1, p1, v2, v3}, Lretrofit2/OkHttpCall;-><init>(Lretrofit2/RequestFactory;[Ljava/lang/Object;Lk/f$a;Lretrofit2/Converter;)V
