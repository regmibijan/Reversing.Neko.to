...
.field final o:Lpl/droidsonroids/gif/g;

.field private final p:Lpl/droidsonroids/gif/k;
...
.field private u:Lpl/droidsonroids/gif/m/a;
...
.method public constructor <init>(Landroid/content/res/Resources;I)V
    ...
    iget-object p2, p0, Lpl/droidsonroids/gif/b;->i:Lpl/droidsonroids/gif/GifInfoHandle;
    ...
    iput p2, p0, Lpl/droidsonroids/gif/b;->t:I
    ...
    iput p1, p0, Lpl/droidsonroids/gif/b;->s:I
...
.method constructor <init>(Lpl/droidsonroids/gif/GifInfoHandle;Lpl/droidsonroids/gif/b;Ljava/util/concurrent/ScheduledThreadPoolExecutor;Z)V
    ...
    iput-boolean v0, p0, Lpl/droidsonroids/gif/b;->d:Z

    const-wide/high16 v1, -0x8000000000000000L

    iput-wide v1, p0, Lpl/droidsonroids/gif/b;->e:J

    new-instance v1, Landroid/graphics/Rect;

    invoke-direct {v1}, Landroid/graphics/Rect;-><init>()V

    iput-object v1, p0, Lpl/droidsonroids/gif/b;->f:Landroid/graphics/Rect;
    ...
    iput-object v1, p0, Lpl/droidsonroids/gif/b;->g:Landroid/graphics/Paint;

    new-instance v1, Ljava/util/concurrent/ConcurrentLinkedQueue;

    invoke-direct {v1}, Ljava/util/concurrent/ConcurrentLinkedQueue;-><init>()V

    iput-object v1, p0, Lpl/droidsonroids/gif/b;->j:Ljava/util/concurrent/ConcurrentLinkedQueue;

    new-instance v1, Lpl/droidsonroids/gif/k;

    invoke-direct {v1, p0}, Lpl/droidsonroids/gif/k;-><init>(Lpl/droidsonroids/gif/b;)V

    iput-object v1, p0, Lpl/droidsonroids/gif/b;->p:Lpl/droidsonroids/gif/k;

    iput-boolean p4, p0, Lpl/droidsonroids/gif/b;->n:Z
    ...
    :goto_0
    iput-object p3, p0, Lpl/droidsonroids/gif/b;->c:Ljava/util/concurrent/ScheduledThreadPoolExecutor;

    iput-object p1, p0, Lpl/droidsonroids/gif/b;->i:Lpl/droidsonroids/gif/GifInfoHandle;
    ...
    iget-object v1, p2, Lpl/droidsonroids/gif/b;->i:Lpl/droidsonroids/gif/GifInfoHandle;

    monitor-enter v1

    :try_start_0
    iget-object v2, p2, Lpl/droidsonroids/gif/b;->i:Lpl/droidsonroids/gif/GifInfoHandle;
    ...
    iget-object v3, p0, Lpl/droidsonroids/gif/b;->i:Lpl/droidsonroids/gif/GifInfoHandle;
    ...
    iget-object p2, p2, Lpl/droidsonroids/gif/b;->h:Landroid/graphics/Bitmap;
    ...
    iget-object p3, p0, Lpl/droidsonroids/gif/b;->i:Lpl/droidsonroids/gif/GifInfoHandle;
    ...
    iput-object p2, p0, Lpl/droidsonroids/gif/b;->h:Landroid/graphics/Bitmap;

    goto :goto_2

    :cond_3
    iput-object p3, p0, Lpl/droidsonroids/gif/b;->h:Landroid/graphics/Bitmap;

    :goto_2
    iget-object p2, p0, Lpl/droidsonroids/gif/b;->h:Landroid/graphics/Bitmap;
    ...
    iput-object p1, p0, Lpl/droidsonroids/gif/b;->q:Landroid/graphics/Rect;

    new-instance p1, Lpl/droidsonroids/gif/g;

    invoke-direct {p1, p0}, Lpl/droidsonroids/gif/g;-><init>(Lpl/droidsonroids/gif/b;)V

    iput-object p1, p0, Lpl/droidsonroids/gif/b;->o:Lpl/droidsonroids/gif/g;

    iget-object p1, p0, Lpl/droidsonroids/gif/b;->p:Lpl/droidsonroids/gif/k;

    invoke-virtual {p1}, Lpl/droidsonroids/gif/k;->a()V

    iget-object p1, p0, Lpl/droidsonroids/gif/b;->i:Lpl/droidsonroids/gif/GifInfoHandle;
    ...
    iput p1, p0, Lpl/droidsonroids/gif/b;->t:I
...
.method private a()V
    ...
    iget-object v0, p0, Lpl/droidsonroids/gif/b;->r:Ljava/util/concurrent/ScheduledFuture;
    ...
    :cond_0
    iget-object v0, p0, Lpl/droidsonroids/gif/b;->o:Lpl/droidsonroids/gif/g;
...
.method private g()V
    ...
    iget-boolean v0, p0, Lpl/droidsonroids/gif/b;->n:Z

    if-eqz v0, :cond_0

    iget-boolean v0, p0, Lpl/droidsonroids/gif/b;->d:Z

    if-eqz v0, :cond_0

    iget-wide v0, p0, Lpl/droidsonroids/gif/b;->e:J
    ...
    iput-wide v2, p0, Lpl/droidsonroids/gif/b;->e:J

    iget-object v2, p0, Lpl/droidsonroids/gif/b;->c:Ljava/util/concurrent/ScheduledThreadPoolExecutor;

    iget-object v3, p0, Lpl/droidsonroids/gif/b;->p:Lpl/droidsonroids/gif/k;
    ...
    iput-object v0, p0, Lpl/droidsonroids/gif/b;->r:Ljava/util/concurrent/ScheduledFuture;
...
.method private i()V
    ...
    iget-object v0, p0, Lpl/droidsonroids/gif/b;->i:Lpl/droidsonroids/gif/GifInfoHandle;
...
.method public c()I
    ...
    iget-object v1, p0, Lpl/droidsonroids/gif/b;->i:Lpl/droidsonroids/gif/GifInfoHandle;
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    iget-object v0, p0, Lpl/droidsonroids/gif/b;->l:Landroid/graphics/PorterDuffColorFilter;

    if-eqz v0, :cond_0

    iget-object v0, p0, Lpl/droidsonroids/gif/b;->g:Landroid/graphics/Paint;
    ...
    iget-object v1, p0, Lpl/droidsonroids/gif/b;->l:Landroid/graphics/PorterDuffColorFilter;
    ...
    :goto_0
    iget-object v1, p0, Lpl/droidsonroids/gif/b;->u:Lpl/droidsonroids/gif/m/a;

    if-nez v1, :cond_1

    iget-object v1, p0, Lpl/droidsonroids/gif/b;->h:Landroid/graphics/Bitmap;

    iget-object v2, p0, Lpl/droidsonroids/gif/b;->q:Landroid/graphics/Rect;

    iget-object v3, p0, Lpl/droidsonroids/gif/b;->f:Landroid/graphics/Rect;

    iget-object v4, p0, Lpl/droidsonroids/gif/b;->g:Landroid/graphics/Paint;
    ...
    :cond_1
    iget-object v2, p0, Lpl/droidsonroids/gif/b;->g:Landroid/graphics/Paint;

    iget-object v3, p0, Lpl/droidsonroids/gif/b;->h:Landroid/graphics/Bitmap;
    ...
    iget-object p1, p0, Lpl/droidsonroids/gif/b;->g:Landroid/graphics/Paint;
...
.method public f()V
    ...
    iget-object v0, p0, Lpl/droidsonroids/gif/b;->c:Ljava/util/concurrent/ScheduledThreadPoolExecutor;
...
.method public getIntrinsicHeight()I
    ...
    iget v0, p0, Lpl/droidsonroids/gif/b;->t:I
...
.method public getIntrinsicWidth()I
    ...
    iget v0, p0, Lpl/droidsonroids/gif/b;->s:I
...
.method public isStateful()Z
    ...
    iget-object v0, p0, Lpl/droidsonroids/gif/b;->k:Landroid/content/res/ColorStateList;
...
.method j(J)V
    ...
    iget-object p1, p0, Lpl/droidsonroids/gif/b;->o:Lpl/droidsonroids/gif/g;
    ...
    iput-object p1, p0, Lpl/droidsonroids/gif/b;->r:Ljava/util/concurrent/ScheduledFuture;
...
.method protected onBoundsChange(Landroid/graphics/Rect;)V
    ...
    iget-object v0, p0, Lpl/droidsonroids/gif/b;->f:Landroid/graphics/Rect;

    invoke-virtual {v0, p1}, Landroid/graphics/Rect;->set(Landroid/graphics/Rect;)V

    iget-object v0, p0, Lpl/droidsonroids/gif/b;->u:Lpl/droidsonroids/gif/m/a;
...
.method protected onStateChange([I)Z
    ...
    iget-object p1, p0, Lpl/droidsonroids/gif/b;->k:Landroid/content/res/ColorStateList;

    if-eqz p1, :cond_0

    iget-object v0, p0, Lpl/droidsonroids/gif/b;->m:Landroid/graphics/PorterDuff$Mode;
    ...
    iput-object p1, p0, Lpl/droidsonroids/gif/b;->l:Landroid/graphics/PorterDuffColorFilter;
...
.method public setTintList(Landroid/content/res/ColorStateList;)V
    ...
    iput-object p1, p0, Lpl/droidsonroids/gif/b;->k:Landroid/content/res/ColorStateList;
...
.method public setTintMode(Landroid/graphics/PorterDuff$Mode;)V
    ...
    iput-object p1, p0, Lpl/droidsonroids/gif/b;->m:Landroid/graphics/PorterDuff$Mode;
...
.method public setVisible(ZZ)Z
    ...
    iget-boolean v1, p0, Lpl/droidsonroids/gif/b;->n:Z
...
.method public toString()Ljava/lang/String;
    ...
    iget-object v2, p0, Lpl/droidsonroids/gif/b;->i:Lpl/droidsonroids/gif/GifInfoHandle;
