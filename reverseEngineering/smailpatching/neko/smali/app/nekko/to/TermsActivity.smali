.class public Lapp/nekko/to/TermsActivity;
...
.method static synthetic X(Lapp/nekko/to/TermsActivity;)Landroid/webkit/WebView;
    .locals 0

    iget-object p0, p0, Lapp/nekko/to/TermsActivity;->r:Landroid/webkit/WebView;
...
.method protected onCreate(Landroid/os/Bundle;)V
    ...
    iput-boolean v0, p0, Lapp/nekko/to/TermsActivity;->s:Z
    ...
    iget-boolean v3, p0, Lapp/nekko/to/TermsActivity;->s:Z
    ...
    invoke-static {p0, v2, v0}, Lapp/nekko/to/TermsActivity;->Y(Landroid/app/Activity;IZ)V
    ...
    invoke-static {p0, v2, v1}, Lapp/nekko/to/TermsActivity;->Y(Landroid/app/Activity;IZ)V
    ...
    iput-object p1, p0, Lapp/nekko/to/TermsActivity;->r:Landroid/webkit/WebView;
    ...
    iget-object v2, p0, Lapp/nekko/to/TermsActivity;->r:Landroid/webkit/WebView;
    ...
    iget-object v1, p0, Lapp/nekko/to/TermsActivity;->r:Landroid/webkit/WebView;
    ...
    const-string v2, "http://nekkoto.app/terms/"

    invoke-virtual {v1, v2}, Landroid/webkit/WebView;->loadUrl(Ljava/lang/String;)V

    iget-object v1, p0, Lapp/nekko/to/TermsActivity;->r:Landroid/webkit/WebView;

    new-instance v2, Lapp/nekko/to/TermsActivity$a;

    invoke-direct {v2, p0}, Lapp/nekko/to/TermsActivity$a;-><init>(Lapp/nekko/to/TermsActivity;)V
    ...
    iget-object p1, p0, Lapp/nekko/to/TermsActivity;->r:Landroid/webkit/WebView;
    ...
    new-instance v0, Lapp/nekko/to/TermsActivity$b;

    invoke-direct {v0, p0}, Lapp/nekko/to/TermsActivity$b;-><init>(Lapp/nekko/to/TermsActivity;)V
    ...
    new-instance v0, Lapp/nekko/to/TermsActivity$c;

    invoke-direct {v0, p0}, Lapp/nekko/to/TermsActivity$c;-><init>(Lapp/nekko/to/TermsActivity;)V
