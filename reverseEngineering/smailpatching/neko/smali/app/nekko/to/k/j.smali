.class public Lapp/nekko/to/k/j;
...
.method public constructor <init>(Landroid/content/Context;Ljava/util/List;)V
    ...
    iput-object v0, p0, Lapp/nekko/to/k/j;->d:Ljava/util/List;

    const/4 v0, -0x1

    iput v0, p0, Lapp/nekko/to/k/j;->f:I

    const/4 v0, 0x1

    iput-boolean v0, p0, Lapp/nekko/to/k/j;->g:Z

    const/4 v0, 0x2

    iput v0, p0, Lapp/nekko/to/k/j;->h:I

    iput-object p2, p0, Lapp/nekko/to/k/j;->d:Ljava/util/List;

    iput-object p1, p0, Lapp/nekko/to/k/j;->e:Landroid/content/Context;

    return-void
.end method

.method static synthetic A(Lapp/nekko/to/k/j;Lapp/nekko/to/k/j$l;ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    .locals 0

    invoke-direct/range {p0 .. p6}, Lapp/nekko/to/k/j;->K(Lapp/nekko/to/k/j$l;ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V

    return-void
.end method

.method static synthetic B(Lapp/nekko/to/k/j;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    .locals 0

    invoke-direct/range {p0 .. p5}, Lapp/nekko/to/k/j;->G(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V

    return-void
.end method

.method static synthetic C(Lapp/nekko/to/k/j;)Ljava/util/List;
    .locals 0

    iget-object p0, p0, Lapp/nekko/to/k/j;->d:Ljava/util/List;

    return-object p0
.end method

.method static synthetic D(Lapp/nekko/to/k/j;Z)Z
    .locals 0

    iput-boolean p1, p0, Lapp/nekko/to/k/j;->g:Z

    return p1
.end method

.method static synthetic E(Lapp/nekko/to/k/j;Z)Z
    .locals 0

    iput-boolean p1, p0, Lapp/nekko/to/k/j;->i:Z

    return p1
.end method

.method static synthetic F(Lapp/nekko/to/k/j;Z)Z
    .locals 0

    iput-boolean p1, p0, Lapp/nekko/to/k/j;->j:Z
...
.method private G(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    new-instance p2, Lapp/nekko/to/k/j$b;

    invoke-direct {p2, p0}, Lapp/nekko/to/k/j$b;-><init>(Lapp/nekko/to/k/j;)V
...
.method private J(Landroid/view/View;I)V
    ...
    iget v0, p0, Lapp/nekko/to/k/j;->f:I

    if-le p2, v0, :cond_1

    iget-boolean v0, p0, Lapp/nekko/to/k/j;->g:Z
    ...
    :goto_0
    iget v1, p0, Lapp/nekko/to/k/j;->h:I

    invoke-static {p1, v0, v1}, Lapp/nekko/to/utils/c;->a(Landroid/view/View;II)V

    iput p2, p0, Lapp/nekko/to/k/j;->f:I

    :cond_1
    return-void
.end method

.method private K(Lapp/nekko/to/k/j$l;ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    .locals 1
    ...
    new-instance p3, Lapp/nekko/to/k/j$a;

    invoke-direct {p3, p0, p1}, Lapp/nekko/to/k/j$a;-><init>(Lapp/nekko/to/k/j;Lapp/nekko/to/k/j$l;)V
...
.method static synthetic z(Lapp/nekko/to/k/j;)Landroid/content/Context;
    .locals 0

    iget-object p0, p0, Lapp/nekko/to/k/j;->e:Landroid/content/Context;
...
# virtual methods
.method public H(Lapp/nekko/to/k/j$l;I)V
    .locals 16
    ...
    iget-object v3, v0, Lapp/nekko/to/k/j;->e:Landroid/content/Context;
    ...
    iget-object v4, v0, Lapp/nekko/to/k/j;->d:Ljava/util/List;
    ...
    invoke-static/range {p1 .. p1}, Lapp/nekko/to/k/j$l;->O(Lapp/nekko/to/k/j$l;)Landroid/widget/TextView;
    ...
    invoke-static/range {p1 .. p1}, Lapp/nekko/to/k/j$l;->P(Lapp/nekko/to/k/j$l;)Landroid/widget/TextView;
    ...
    invoke-static/range {p1 .. p1}, Lapp/nekko/to/k/j$l;->Y(Lapp/nekko/to/k/j$l;)Landroid/widget/TextView;
    ...
    invoke-static/range {p1 .. p1}, Lapp/nekko/to/k/j$l;->b0(Lapp/nekko/to/k/j$l;)Landroid/widget/TextView;
    ...
    invoke-static/range {p1 .. p1}, Lapp/nekko/to/k/j$l;->c0(Lapp/nekko/to/k/j$l;)Landroid/widget/TextView;
    ...
    invoke-static/range {p1 .. p1}, Lapp/nekko/to/k/j$l;->d0(Lapp/nekko/to/k/j$l;)Landroid/widget/LinearLayout;

    move-result-object v3

    invoke-virtual {v3, v5}, Landroid/widget/LinearLayout;->setVisibility(I)V

    invoke-static/range {p1 .. p1}, Lapp/nekko/to/k/j$l;->e0(Lapp/nekko/to/k/j$l;)Landroid/widget/LinearLayout;
    ...
    iget-object v13, v0, Lapp/nekko/to/k/j;->e:Landroid/content/Context;
    ...
    invoke-static/range {p1 .. p1}, Lapp/nekko/to/k/j$l;->f0(Lapp/nekko/to/k/j$l;)Landroid/widget/TextView;
    ...
    invoke-static/range {p1 .. p1}, Lapp/nekko/to/k/j$l;->g0(Lapp/nekko/to/k/j$l;)Landroid/widget/ImageView;
    ...
    invoke-static/range {p1 .. p1}, Lapp/nekko/to/k/j$l;->h0(Lapp/nekko/to/k/j$l;)Landroid/widget/ImageView;
    ...
    invoke-static/range {p1 .. p1}, Lapp/nekko/to/k/j$l;->Q(Lapp/nekko/to/k/j$l;)Landroid/widget/TextView;
    ...
    :goto_8
    invoke-static/range {p1 .. p1}, Lapp/nekko/to/k/j$l;->R(Lapp/nekko/to/k/j$l;)Landroid/widget/ImageView;
    ...
    iget-object v6, v0, Lapp/nekko/to/k/j;->e:Landroid/content/Context;
    ...
    :cond_1a
    :goto_f
    invoke-static/range {p1 .. p1}, Lapp/nekko/to/k/j$l;->S(Lapp/nekko/to/k/j$l;)Landroid/widget/LinearLayout;

    move-result-object v3

    new-instance v5, Lapp/nekko/to/k/j$c;

    invoke-direct {v5, v0, v4}, Lapp/nekko/to/k/j$c;-><init>(Lapp/nekko/to/k/j;Lapp/nekko/to/o/a;)V

    invoke-virtual {v3, v5}, Landroid/widget/LinearLayout;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    invoke-static/range {p1 .. p1}, Lapp/nekko/to/k/j$l;->T(Lapp/nekko/to/k/j$l;)Landroid/widget/LinearLayout;

    move-result-object v3

    new-instance v5, Lapp/nekko/to/k/j$d;

    invoke-direct {v5, v0, v4}, Lapp/nekko/to/k/j$d;-><init>(Lapp/nekko/to/k/j;Lapp/nekko/to/o/a;)V
    ...
    invoke-static/range {p1 .. p1}, Lapp/nekko/to/k/j$l;->U(Lapp/nekko/to/k/j$l;)Landroid/widget/ImageView;
    ...
    invoke-static/range {p1 .. p1}, Lapp/nekko/to/k/j$l;->V(Lapp/nekko/to/k/j$l;)Landroid/widget/ImageView;
    ...
    new-instance v5, Lapp/nekko/to/k/j$e;

    invoke-direct {v5, v0, v1, v4, v2}, Lapp/nekko/to/k/j$e;-><init>(Lapp/nekko/to/k/j;Lapp/nekko/to/k/j$l;Lapp/nekko/to/o/a;I)V
    ...
    new-instance v5, Lapp/nekko/to/k/j$f;

    invoke-direct {v5, v0, v1, v4, v2}, Lapp/nekko/to/k/j$f;-><init>(Lapp/nekko/to/k/j;Lapp/nekko/to/k/j$l;Lapp/nekko/to/o/a;I)V

    invoke-virtual {v3, v5}, Landroid/widget/ImageView;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    invoke-static/range {p1 .. p1}, Lapp/nekko/to/k/j$l;->a0(Lapp/nekko/to/k/j$l;)Landroid/widget/ImageView;

    move-result-object v3

    new-instance v5, Lapp/nekko/to/k/j$g;

    invoke-direct {v5, v0, v1}, Lapp/nekko/to/k/j$g;-><init>(Lapp/nekko/to/k/j;Lapp/nekko/to/k/j$l;)V

    invoke-virtual {v3, v5}, Landroid/widget/ImageView;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    invoke-static/range {p1 .. p1}, Lapp/nekko/to/k/j$l;->Z(Lapp/nekko/to/k/j$l;)Landroidx/cardview/widget/CardView;

    move-result-object v3

    new-instance v5, Lapp/nekko/to/k/j$h;

    invoke-direct {v5, v0, v1}, Lapp/nekko/to/k/j$h;-><init>(Lapp/nekko/to/k/j;Lapp/nekko/to/k/j$l;)V
    ...
    new-instance v5, Lapp/nekko/to/k/j$i;

    invoke-direct {v5, v0, v4}, Lapp/nekko/to/k/j$i;-><init>(Lapp/nekko/to/k/j;Lapp/nekko/to/o/a;)V
    ...
    new-instance v5, Lapp/nekko/to/k/j$j;

    invoke-direct {v5, v0, v4, v2, v1}, Lapp/nekko/to/k/j$j;-><init>(Lapp/nekko/to/k/j;Lapp/nekko/to/o/a;ILapp/nekko/to/k/j$l;)V

    invoke-virtual {v3, v5}, Landroid/widget/LinearLayout;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    iget-object v1, v1, Landroidx/recyclerview/widget/RecyclerView$e0;->a:Landroid/view/View;

    invoke-direct {v0, v1, v2}, Lapp/nekko/to/k/j;->J(Landroid/view/View;I)V

    return-void
.end method

.method public I(Landroid/view/ViewGroup;I)Lapp/nekko/to/k/j$l;
    .locals 2
    ...
    new-instance p2, Lapp/nekko/to/k/j$l;

    invoke-direct {p2, p0, p1}, Lapp/nekko/to/k/j$l;-><init>(Lapp/nekko/to/k/j;Landroid/view/View;)V
...
.method public e()I
    ...
    iget-object v0, p0, Lapp/nekko/to/k/j;->d:Ljava/util/List;
...
.method public n(Landroidx/recyclerview/widget/RecyclerView;)V
    ...
    new-instance v0, Lapp/nekko/to/k/j$k;

    invoke-direct {v0, p0, p1}, Lapp/nekko/to/k/j$k;-><init>(Lapp/nekko/to/k/j;Landroidx/recyclerview/widget/RecyclerView;)V
...
.method public bridge synthetic o(Landroidx/recyclerview/widget/RecyclerView$e0;I)V
    ...
    check-cast p1, Lapp/nekko/to/k/j$l;

    invoke-virtual {p0, p1, p2}, Lapp/nekko/to/k/j;->H(Lapp/nekko/to/k/j$l;I)V
...
.method public bridge synthetic q(Landroid/view/ViewGroup;I)Landroidx/recyclerview/widget/RecyclerView$e0;
    ...
    invoke-virtual {p0, p1, p2}, Lapp/nekko/to/k/j;->I(Landroid/view/ViewGroup;I)Lapp/nekko/to/k/j$l;
