.class public Lapp/nekko/to/k/t;
...
.method public constructor <init>(Landroid/content/Context;Ljava/util/List;)V
    ...
    iput-object v0, p0, Lapp/nekko/to/k/t;->d:Ljava/util/List;

    iput-object p2, p0, Lapp/nekko/to/k/t;->d:Ljava/util/List;

    iput-object p1, p0, Lapp/nekko/to/k/t;->e:Landroid/content/Context;

    iput-object p1, p0, Lapp/nekko/to/k/t;->f:Landroid/content/Context;

    return-void
.end method

.method static synthetic A(Lapp/nekko/to/k/t;Z)Z
    .locals 0

    iput-boolean p1, p0, Lapp/nekko/to/k/t;->g:Z

    return p1
.end method

.method static synthetic z(Lapp/nekko/to/k/t;)Landroid/content/Context;
    .locals 0

    iget-object p0, p0, Lapp/nekko/to/k/t;->e:Landroid/content/Context;
...
.method public C(Lapp/nekko/to/k/t$c;I)V
    .locals 3

    iget-object v0, p0, Lapp/nekko/to/k/t;->d:Ljava/util/List;
    ...
    iget-object v0, p1, Lapp/nekko/to/k/t$c;->v:Landroid/widget/TextView;
    ...
    iget-object v0, p1, Lapp/nekko/to/k/t$c;->x:Landroid/widget/TextView;
    ...
    :cond_0
    iget-object v0, p1, Lapp/nekko/to/k/t$c;->w:Landroid/widget/TextView;
    ...
    iget-object v1, p0, Lapp/nekko/to/k/t;->e:Landroid/content/Context;
    ...
    iget-object v1, p1, Lapp/nekko/to/k/t$c;->u:Landroid/widget/ImageView;

    invoke-virtual {v0, v1}, Lcom/bumptech/glide/i;->C0(Landroid/widget/ImageView;)Lcom/bumptech/glide/q/j/i;

    iget-object p1, p1, Lapp/nekko/to/k/t$c;->y:Landroidx/cardview/widget/CardView;

    new-instance v0, Lapp/nekko/to/k/t$a;

    invoke-direct {v0, p0, p2}, Lapp/nekko/to/k/t$a;-><init>(Lapp/nekko/to/k/t;Lapp/nekko/to/o/b;)V
...
.method public D(Landroid/view/ViewGroup;I)Lapp/nekko/to/k/t$c;
    .locals 4
    ...
    iget-object v0, p0, Lapp/nekko/to/k/t;->f:Landroid/content/Context;

    invoke-virtual {p0, v0}, Lapp/nekko/to/k/t;->B(Landroid/content/Context;)I
    ...
    new-instance p2, Lapp/nekko/to/k/t$c;

    invoke-direct {p2, p0, p1}, Lapp/nekko/to/k/t$c;-><init>(Lapp/nekko/to/k/t;Landroid/view/View;)V
...
.method public n(Landroidx/recyclerview/widget/RecyclerView;)V
    ...
    new-instance v0, Lapp/nekko/to/k/t$b;

    invoke-direct {v0, p0}, Lapp/nekko/to/k/t$b;-><init>(Lapp/nekko/to/k/t;)V
...
.method public bridge synthetic o(Landroidx/recyclerview/widget/RecyclerView$e0;I)V
    ...
    check-cast p1, Lapp/nekko/to/k/t$c;

    invoke-virtual {p0, p1, p2}, Lapp/nekko/to/k/t;->C(Lapp/nekko/to/k/t$c;I)V
...
.method public bridge synthetic q(Landroid/view/ViewGroup;I)Landroidx/recyclerview/widget/RecyclerView$e0;
    ...
    invoke-virtual {p0, p1, p2}, Lapp/nekko/to/k/t;->D(Landroid/view/ViewGroup;I)Lapp/nekko/to/k/t$c;
