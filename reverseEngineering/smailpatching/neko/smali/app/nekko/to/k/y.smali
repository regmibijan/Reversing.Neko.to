.class public Lapp/nekko/to/k/y;
...
.method public constructor <init>(Landroid/content/Context;Ljava/util/List;)V
    ...
    iput-object v0, p0, Lapp/nekko/to/k/y;->d:Ljava/util/List;

    iput-object p2, p0, Lapp/nekko/to/k/y;->d:Ljava/util/List;

    iput-object p1, p0, Lapp/nekko/to/k/y;->e:Landroid/content/Context;

    return-void
.end method

.method static synthetic A(Lapp/nekko/to/k/y;Ljava/lang/String;)V
    .locals 0

    invoke-direct {p0, p1}, Lapp/nekko/to/k/y;->B(Ljava/lang/String;)V
...
.method private B(Ljava/lang/String;)V
    ...
    new-instance v4, Lapp/nekko/to/k/y$c;

    invoke-direct {v4, p0}, Lapp/nekko/to/k/y$c;-><init>(Lapp/nekko/to/k/y;)V

    new-instance v5, Lapp/nekko/to/k/y$d;

    invoke-direct {v5, p0}, Lapp/nekko/to/k/y$d;-><init>(Lapp/nekko/to/k/y;)V
    ...
    iget-object p1, p0, Lapp/nekko/to/k/y;->e:Landroid/content/Context;
...
.method static synthetic z(Lapp/nekko/to/k/y;)Landroid/content/Context;
    .locals 0

    iget-object p0, p0, Lapp/nekko/to/k/y;->e:Landroid/content/Context;
...
# virtual methods
.method public C(Lapp/nekko/to/k/y$e;I)V
    .locals 7

    iget-object v0, p0, Lapp/nekko/to/k/y;->d:Ljava/util/List;
    ...
    invoke-static {p1}, Lapp/nekko/to/k/y$e;->O(Lapp/nekko/to/k/y$e;)Landroidx/cardview/widget/CardView;
    ...
    iget-object v0, p1, Lapp/nekko/to/k/y$e;->v:Landroid/widget/TextView;
    ...
    invoke-static {p1}, Lapp/nekko/to/k/y$e;->P(Lapp/nekko/to/k/y$e;)Landroid/widget/ImageView;
    ...
    iget-object v3, p0, Lapp/nekko/to/k/y;->e:Landroid/content/Context;
    ...
    iget-object v5, p0, Lapp/nekko/to/k/y;->e:Landroid/content/Context;
    ...
    iget-object v1, p1, Lapp/nekko/to/k/y$e;->u:Landroid/widget/TextView;

    sget-object v2, Landroid/widget/TextView$BufferType;->SPANNABLE:Landroid/widget/TextView$BufferType;

    invoke-virtual {v1, v0, v2}, Landroid/widget/TextView;->setText(Ljava/lang/CharSequence;Landroid/widget/TextView$BufferType;)V

    invoke-static {p1}, Lapp/nekko/to/k/y$e;->Q(Lapp/nekko/to/k/y$e;)Landroidx/cardview/widget/CardView;

    move-result-object v0

    invoke-virtual {v0, v4}, Landroid/widget/FrameLayout;->setVisibility(I)V

    iget-object v0, p1, Lapp/nekko/to/k/y$e;->u:Landroid/widget/TextView;

    new-instance v1, Lapp/nekko/to/k/y$a;

    invoke-direct {v1, p0, p2, p1}, Lapp/nekko/to/k/y$a;-><init>(Lapp/nekko/to/k/y;Lapp/nekko/to/o/b;Lapp/nekko/to/k/y$e;)V
    ...
    new-instance v1, Lapp/nekko/to/k/y$b;

    invoke-direct {v1, p0, p2, p1}, Lapp/nekko/to/k/y$b;-><init>(Lapp/nekko/to/k/y;Lapp/nekko/to/o/b;Lapp/nekko/to/k/y$e;)V
...
.method public D(Landroid/view/ViewGroup;I)Lapp/nekko/to/k/y$e;
    .locals 2
    ...
    new-instance p2, Lapp/nekko/to/k/y$e;

    invoke-direct {p2, p0, p1}, Lapp/nekko/to/k/y$e;-><init>(Lapp/nekko/to/k/y;Landroid/view/View;)V
...
.method public bridge synthetic o(Landroidx/recyclerview/widget/RecyclerView$e0;I)V
    ...
    check-cast p1, Lapp/nekko/to/k/y$e;

    invoke-virtual {p0, p1, p2}, Lapp/nekko/to/k/y;->C(Lapp/nekko/to/k/y$e;I)V
...
.method public bridge synthetic q(Landroid/view/ViewGroup;I)Landroidx/recyclerview/widget/RecyclerView$e0;
    ...
    invoke-virtual {p0, p1, p2}, Lapp/nekko/to/k/y;->D(Landroid/view/ViewGroup;I)Lapp/nekko/to/k/y$e;
