.class public Lapp/nekko/to/k/o;
...
.method public constructor <init>(Landroid/content/Context;Ljava/util/List;)V
    ...
    iput-object v0, p0, Lapp/nekko/to/k/o;->d:Ljava/util/List;

    iput-object p2, p0, Lapp/nekko/to/k/o;->d:Ljava/util/List;

    iput-object p1, p0, Lapp/nekko/to/k/o;->e:Landroid/content/Context;

    return-void
.end method

.method static synthetic A(Lapp/nekko/to/k/o;Z)Z
    .locals 0

    iput-boolean p1, p0, Lapp/nekko/to/k/o;->f:Z

    return p1
.end method

.method static synthetic z(Lapp/nekko/to/k/o;)Landroid/content/Context;
    .locals 0

    iget-object p0, p0, Lapp/nekko/to/k/o;->e:Landroid/content/Context;
...
# virtual methods
.method public B(Lapp/nekko/to/k/o$c;I)V
    .locals 2

    iget-object v0, p0, Lapp/nekko/to/k/o;->d:Ljava/util/List;
    ...
    iget-object v0, p1, Lapp/nekko/to/k/o$c;->v:Landroid/widget/TextView;
    ...
    iget-object v0, p1, Lapp/nekko/to/k/o$c;->x:Landroid/widget/TextView;
    ...
    iget-object v0, p1, Lapp/nekko/to/k/o$c;->y:Landroid/widget/TextView;
    ...
    iget-object v0, p0, Lapp/nekko/to/k/o;->e:Landroid/content/Context;
    ...
    invoke-static {p1}, Lapp/nekko/to/k/o$c;->O(Lapp/nekko/to/k/o$c;)Landroid/widget/ImageView;

    move-result-object v1

    invoke-virtual {v0, v1}, Lcom/bumptech/glide/i;->C0(Landroid/widget/ImageView;)Lcom/bumptech/glide/q/j/i;

    iget-object v0, p1, Lapp/nekko/to/k/o$c;->w:Landroid/widget/TextView;
    ...
    new-instance v0, Lapp/nekko/to/k/o$a;

    invoke-direct {v0, p0, p2}, Lapp/nekko/to/k/o$a;-><init>(Lapp/nekko/to/k/o;Lapp/nekko/to/o/b;)V
...
.method public C(Landroid/view/ViewGroup;I)Lapp/nekko/to/k/o$c;
    .locals 2
    ...
    new-instance p2, Lapp/nekko/to/k/o$c;

    invoke-direct {p2, p0, p1}, Lapp/nekko/to/k/o$c;-><init>(Lapp/nekko/to/k/o;Landroid/view/View;)V
...
.method public n(Landroidx/recyclerview/widget/RecyclerView;)V
    ...
    new-instance v0, Lapp/nekko/to/k/o$b;

    invoke-direct {v0, p0}, Lapp/nekko/to/k/o$b;-><init>(Lapp/nekko/to/k/o;)V
...
.method public bridge synthetic o(Landroidx/recyclerview/widget/RecyclerView$e0;I)V
    ...
    check-cast p1, Lapp/nekko/to/k/o$c;

    invoke-virtual {p0, p1, p2}, Lapp/nekko/to/k/o;->B(Lapp/nekko/to/k/o$c;I)V
...
.method public bridge synthetic q(Landroid/view/ViewGroup;I)Landroidx/recyclerview/widget/RecyclerView$e0;
    ...
    invoke-virtual {p0, p1, p2}, Lapp/nekko/to/k/o;->C(Landroid/view/ViewGroup;I)Lapp/nekko/to/k/o$c;
