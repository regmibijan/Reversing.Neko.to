.class public Lapp/nekko/to/l/a;
...
.field private b0:Lapp/nekko/to/k/r0;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lapp/nekko/to/l/a;->d0:Ljava/util/List;

    return-void
.end method

.method static synthetic V1(Lapp/nekko/to/l/a;)Landroid/widget/LinearLayout;
    .locals 0

    iget-object p0, p0, Lapp/nekko/to/l/a;->a0:Landroid/widget/LinearLayout;

    return-object p0
.end method

.method static synthetic W1(Lapp/nekko/to/l/a;)Ljava/util/List;
    .locals 0

    iget-object p0, p0, Lapp/nekko/to/l/a;->d0:Ljava/util/List;

    return-object p0
.end method

.method static synthetic X1(Lapp/nekko/to/l/a;)Lapp/nekko/to/k/r0;
    .locals 0

    iget-object p0, p0, Lapp/nekko/to/l/a;->b0:Lapp/nekko/to/k/r0;
...
.method private Y1(Ljava/lang/String;)V
    ...
    new-instance v4, Lapp/nekko/to/l/a$a;

    invoke-direct {v4, p0}, Lapp/nekko/to/l/a$a;-><init>(Lapp/nekko/to/l/a;)V

    new-instance v5, Lapp/nekko/to/l/a$b;

    invoke-direct {v5, p0}, Lapp/nekko/to/l/a$b;-><init>(Lapp/nekko/to/l/a;)V
...
.method private Z1(Landroid/view/View;)V
    ...
    iput-object v0, p0, Lapp/nekko/to/l/a;->a0:Landroid/widget/LinearLayout;
    ...
    iput-object p1, p0, Lapp/nekko/to/l/a;->c0:Landroidx/recyclerview/widget/RecyclerView;

    iget-object p1, p0, Lapp/nekko/to/l/a;->a0:Landroid/widget/LinearLayout;

    const/4 v0, 0x0

    invoke-virtual {p1, v0}, Landroid/widget/LinearLayout;->setVisibility(I)V

    iget-object p1, p0, Lapp/nekko/to/l/a;->c0:Landroidx/recyclerview/widget/RecyclerView;
    ...
    new-instance p1, Lapp/nekko/to/k/r0;

    invoke-static {}, Lapp/nekko/to/utils/MyAppClass;->a()Landroid/content/Context;

    move-result-object v1

    iget-object v2, p0, Lapp/nekko/to/l/a;->d0:Ljava/util/List;

    invoke-direct {p1, v1, v2}, Lapp/nekko/to/k/r0;-><init>(Landroid/content/Context;Ljava/util/List;)V

    iput-object p1, p0, Lapp/nekko/to/l/a;->b0:Lapp/nekko/to/k/r0;

    iget-object v1, p0, Lapp/nekko/to/l/a;->c0:Landroidx/recyclerview/widget/RecyclerView;
    ...
    iput-object p1, p0, Lapp/nekko/to/l/a;->e0:Ljava/lang/String;
    ...
    iget-object p1, p0, Lapp/nekko/to/l/a;->e0:Ljava/lang/String;
    ...
    invoke-direct {p0, p1}, Lapp/nekko/to/l/a;->Y1(Ljava/lang/String;)V
...
.method public Y0(Landroid/view/View;Landroid/os/Bundle;)V
    ...
    invoke-direct {p0, p1}, Lapp/nekko/to/l/a;->Z1(Landroid/view/View;)V
