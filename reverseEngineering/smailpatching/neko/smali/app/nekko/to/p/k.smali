.class public Lapp/nekko/to/p/k;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lapp/nekko/to/p/k;->d0:Ljava/util/List;

    const/4 v0, 0x1

    iput v0, p0, Lapp/nekko/to/p/k;->h0:I

    return-void
.end method

.method static synthetic V1(Lapp/nekko/to/p/k;Z)Z
    .locals 0

    iput-boolean p1, p0, Lapp/nekko/to/p/k;->g0:Z

    return p1
.end method

.method static synthetic W1(Lapp/nekko/to/p/k;)Landroid/widget/LinearLayout;
    .locals 0

    iget-object p0, p0, Lapp/nekko/to/p/k;->a0:Landroid/widget/LinearLayout;

    return-object p0
.end method

.method static synthetic X1(Lapp/nekko/to/p/k;)Ljava/util/List;
    .locals 0

    iget-object p0, p0, Lapp/nekko/to/p/k;->d0:Ljava/util/List;

    return-object p0
.end method

.method static synthetic Y1(Lapp/nekko/to/p/k;)Lapp/nekko/to/k/s0;
    .locals 0

    iget-object p0, p0, Lapp/nekko/to/p/k;->c0:Lapp/nekko/to/k/s0;

    return-object p0
.end method

.method static synthetic Z1(Lapp/nekko/to/p/k;)I
    .locals 0

    iget p0, p0, Lapp/nekko/to/p/k;->h0:I
...
.method private a2(Ljava/lang/String;)V
    ...
    new-instance v4, Lapp/nekko/to/p/k$a;

    invoke-direct {v4, p0}, Lapp/nekko/to/p/k$a;-><init>(Lapp/nekko/to/p/k;)V

    new-instance v5, Lapp/nekko/to/p/k$b;

    invoke-direct {v5, p0}, Lapp/nekko/to/p/k$b;-><init>(Lapp/nekko/to/p/k;)V
...
.method private b2(Landroid/view/View;)V
    ...
    iput-object v0, p0, Lapp/nekko/to/p/k;->a0:Landroid/widget/LinearLayout;
    ...
    iput-object p1, p0, Lapp/nekko/to/p/k;->b0:Landroidx/recyclerview/widget/RecyclerView;
    ...
    iget-object p1, p0, Lapp/nekko/to/p/k;->b0:Landroidx/recyclerview/widget/RecyclerView;
    ...
    iget-object v2, p0, Lapp/nekko/to/p/k;->d0:Ljava/util/List;

    invoke-direct {p1, v0, v2}, Lapp/nekko/to/k/s0;-><init>(Landroid/content/Context;Ljava/util/List;)V

    iput-object p1, p0, Lapp/nekko/to/p/k;->c0:Lapp/nekko/to/k/s0;

    iget-object v0, p0, Lapp/nekko/to/p/k;->b0:Landroidx/recyclerview/widget/RecyclerView;
    ...
    invoke-direct {p0, p1}, Lapp/nekko/to/p/k;->a2(Ljava/lang/String;)V
...
.method public Y0(Landroid/view/View;Landroid/os/Bundle;)V
    ...
    invoke-direct {p0, p1}, Lapp/nekko/to/p/k;->b2(Landroid/view/View;)V
