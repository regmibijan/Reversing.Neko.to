.class public Lapp/nekko/to/p/j;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lapp/nekko/to/p/j;->d0:Ljava/util/List;

    const/4 v0, 0x1

    iput v0, p0, Lapp/nekko/to/p/j;->f0:I

    return-void
.end method

.method static synthetic V1(Lapp/nekko/to/p/j;Z)Z
    .locals 0

    iput-boolean p1, p0, Lapp/nekko/to/p/j;->e0:Z

    return p1
.end method

.method static synthetic W1(Lapp/nekko/to/p/j;)Landroid/widget/LinearLayout;
    .locals 0

    iget-object p0, p0, Lapp/nekko/to/p/j;->a0:Landroid/widget/LinearLayout;

    return-object p0
.end method

.method static synthetic X1(Lapp/nekko/to/p/j;)Ljava/util/List;
    .locals 0

    iget-object p0, p0, Lapp/nekko/to/p/j;->d0:Ljava/util/List;

    return-object p0
.end method

.method static synthetic Y1(Lapp/nekko/to/p/j;)Lapp/nekko/to/k/s0;
    .locals 0

    iget-object p0, p0, Lapp/nekko/to/p/j;->c0:Lapp/nekko/to/k/s0;

    return-object p0
.end method

.method static synthetic Z1(Lapp/nekko/to/p/j;)I
    .locals 0

    iget p0, p0, Lapp/nekko/to/p/j;->f0:I
...
.method private a2(Ljava/lang/String;)V
    ...
    new-instance v4, Lapp/nekko/to/p/j$a;

    invoke-direct {v4, p0}, Lapp/nekko/to/p/j$a;-><init>(Lapp/nekko/to/p/j;)V

    new-instance v5, Lapp/nekko/to/p/j$b;

    invoke-direct {v5, p0}, Lapp/nekko/to/p/j$b;-><init>(Lapp/nekko/to/p/j;)V
...
.method private b2(Landroid/view/View;)V
    ...
    iput-object v0, p0, Lapp/nekko/to/p/j;->a0:Landroid/widget/LinearLayout;
    ...
    iput-object p1, p0, Lapp/nekko/to/p/j;->b0:Landroidx/recyclerview/widget/RecyclerView;
    ...
    iget-object p1, p0, Lapp/nekko/to/p/j;->b0:Landroidx/recyclerview/widget/RecyclerView;
    ...
    iget-object v2, p0, Lapp/nekko/to/p/j;->d0:Ljava/util/List;

    invoke-direct {p1, v0, v2}, Lapp/nekko/to/k/s0;-><init>(Landroid/content/Context;Ljava/util/List;)V

    iput-object p1, p0, Lapp/nekko/to/p/j;->c0:Lapp/nekko/to/k/s0;

    iget-object v0, p0, Lapp/nekko/to/p/j;->b0:Landroidx/recyclerview/widget/RecyclerView;
    ...
    invoke-direct {p0, p1}, Lapp/nekko/to/p/j;->a2(Ljava/lang/String;)V
...
.method public Y0(Landroid/view/View;Landroid/os/Bundle;)V
    ...
    invoke-direct {p0, p1}, Lapp/nekko/to/p/j;->b2(Landroid/view/View;)V
