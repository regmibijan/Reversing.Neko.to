.class public Lapp/nekko/to/p/g;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lapp/nekko/to/p/g;->d0:Ljava/util/List;

    const/4 v0, 0x1

    iput v0, p0, Lapp/nekko/to/p/g;->f0:I

    return-void
.end method

.method static synthetic V1(Lapp/nekko/to/p/g;Z)Z
    .locals 0

    iput-boolean p1, p0, Lapp/nekko/to/p/g;->e0:Z

    return p1
.end method

.method static synthetic W1(Lapp/nekko/to/p/g;)Landroid/widget/LinearLayout;
    .locals 0

    iget-object p0, p0, Lapp/nekko/to/p/g;->a0:Landroid/widget/LinearLayout;

    return-object p0
.end method

.method static synthetic X1(Lapp/nekko/to/p/g;)Ljava/util/List;
    .locals 0

    iget-object p0, p0, Lapp/nekko/to/p/g;->d0:Ljava/util/List;

    return-object p0
.end method

.method static synthetic Y1(Lapp/nekko/to/p/g;)Lapp/nekko/to/k/s0;
    .locals 0

    iget-object p0, p0, Lapp/nekko/to/p/g;->c0:Lapp/nekko/to/k/s0;

    return-object p0
.end method

.method static synthetic Z1(Lapp/nekko/to/p/g;)I
    .locals 0

    iget p0, p0, Lapp/nekko/to/p/g;->f0:I
...
.method private a2(Ljava/lang/String;)V
    ...
    new-instance v4, Lapp/nekko/to/p/g$a;

    invoke-direct {v4, p0}, Lapp/nekko/to/p/g$a;-><init>(Lapp/nekko/to/p/g;)V

    new-instance v5, Lapp/nekko/to/p/g$b;

    invoke-direct {v5, p0}, Lapp/nekko/to/p/g$b;-><init>(Lapp/nekko/to/p/g;)V
...
.method private b2(Landroid/view/View;)V
    ...
    iput-object v0, p0, Lapp/nekko/to/p/g;->a0:Landroid/widget/LinearLayout;
    ...
    iput-object p1, p0, Lapp/nekko/to/p/g;->b0:Landroidx/recyclerview/widget/RecyclerView;
    ...
    iget-object p1, p0, Lapp/nekko/to/p/g;->b0:Landroidx/recyclerview/widget/RecyclerView;
    ...
    iget-object v2, p0, Lapp/nekko/to/p/g;->d0:Ljava/util/List;

    invoke-direct {p1, v0, v2}, Lapp/nekko/to/k/s0;-><init>(Landroid/content/Context;Ljava/util/List;)V

    iput-object p1, p0, Lapp/nekko/to/p/g;->c0:Lapp/nekko/to/k/s0;

    iget-object v0, p0, Lapp/nekko/to/p/g;->b0:Landroidx/recyclerview/widget/RecyclerView;
    ...
    invoke-direct {p0, p1}, Lapp/nekko/to/p/g;->a2(Ljava/lang/String;)V
...
.method public Y0(Landroid/view/View;Landroid/os/Bundle;)V
    ...
    invoke-direct {p0, p1}, Lapp/nekko/to/p/g;->b2(Landroid/view/View;)V
