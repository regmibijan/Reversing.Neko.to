.class public Lapp/nekko/to/p/a;
...
.field private c0:Lapp/nekko/to/k/q;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lapp/nekko/to/p/a;->a0:Ljava/util/List;

    return-void
.end method

.method static synthetic V1(Lapp/nekko/to/p/a;)Ljava/util/List;
    .locals 0

    iget-object p0, p0, Lapp/nekko/to/p/a;->a0:Ljava/util/List;

    return-object p0
.end method

.method static synthetic W1(Lapp/nekko/to/p/a;)Lapp/nekko/to/k/q;
    .locals 0

    iget-object p0, p0, Lapp/nekko/to/p/a;->c0:Lapp/nekko/to/k/q;
...
.method private X1(Ljava/lang/String;)V
    ...
    new-instance v4, Lapp/nekko/to/p/a$a;

    invoke-direct {v4, p0}, Lapp/nekko/to/p/a$a;-><init>(Lapp/nekko/to/p/a;)V

    new-instance v5, Lapp/nekko/to/p/a$b;

    invoke-direct {v5, p0}, Lapp/nekko/to/p/a$b;-><init>(Lapp/nekko/to/p/a;)V
...
.method private Y1(Landroid/view/View;)V
    ...
    iput-object p1, p0, Lapp/nekko/to/p/a;->b0:Landroidx/recyclerview/widget/RecyclerView;
    ...
    iget-object p1, p0, Lapp/nekko/to/p/a;->b0:Landroidx/recyclerview/widget/RecyclerView;
    ...
    new-instance p1, Lapp/nekko/to/k/q;

    invoke-virtual {p0}, Landroidx/fragment/app/Fragment;->E()Landroid/content/Context;

    move-result-object v1

    iget-object v2, p0, Lapp/nekko/to/p/a;->a0:Ljava/util/List;

    invoke-direct {p1, v1, v2}, Lapp/nekko/to/k/q;-><init>(Landroid/content/Context;Ljava/util/List;)V

    iput-object p1, p0, Lapp/nekko/to/p/a;->c0:Lapp/nekko/to/k/q;

    iget-object v1, p0, Lapp/nekko/to/p/a;->b0:Landroidx/recyclerview/widget/RecyclerView;
    ...
    invoke-virtual {v1}, Lapp/nekko/to/utils/a;->N()Ljava/lang/String;
    ...
    invoke-direct {p0, p1}, Lapp/nekko/to/p/a;->X1(Ljava/lang/String;)V
...
.method public Y0(Landroid/view/View;Landroid/os/Bundle;)V
    ...
    invoke-direct {p0, p1}, Lapp/nekko/to/p/a;->Y1(Landroid/view/View;)V
