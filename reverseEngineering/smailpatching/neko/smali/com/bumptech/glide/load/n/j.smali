...
.method public constructor <init>(Lcom/bumptech/glide/load/p/g;I)V
    ...
    invoke-direct {p0, p1, p2, v0}, Lcom/bumptech/glide/load/n/j;-><init>(Lcom/bumptech/glide/load/p/g;ILcom/bumptech/glide/load/n/j$b;)V

    return-void
.end method

.method constructor <init>(Lcom/bumptech/glide/load/p/g;ILcom/bumptech/glide/load/n/j$b;)V
    .locals 0
    ...
    iput-object p3, p0, Lcom/bumptech/glide/load/n/j;->e:Lcom/bumptech/glide/load/n/j$b;
...
.method private c(Ljava/net/HttpURLConnection;)Ljava/io/InputStream;
    ...
    invoke-static {p1, v0, v1}, Lcom/bumptech/glide/s/c;->i(Ljava/io/InputStream;J)Ljava/io/InputStream;
...
.method private h(Ljava/net/URL;ILjava/net/URL;Ljava/util/Map;)Ljava/io/InputStream;
    ...
    invoke-interface {p3, p1}, Lcom/bumptech/glide/load/n/j$b;->a(Ljava/net/URL;)Ljava/net/HttpURLConnection;
    ...
    invoke-static {p3}, Lcom/bumptech/glide/load/n/j;->f(I)Z
    ...
    invoke-direct {p0, p1}, Lcom/bumptech/glide/load/n/j;->c(Ljava/net/HttpURLConnection;)Ljava/io/InputStream;
    ...
    :cond_4
    invoke-static {p3}, Lcom/bumptech/glide/load/n/j;->g(I)Z
    ...
    invoke-direct {p0, v0, p2, p1, p4}, Lcom/bumptech/glide/load/n/j;->h(Ljava/net/URL;ILjava/net/URL;Ljava/util/Map;)Ljava/io/InputStream;
...
.method public e(Lcom/bumptech/glide/f;Lcom/bumptech/glide/load/n/d$a;)V
    ...
    invoke-virtual {v4}, Lcom/bumptech/glide/load/p/g;->h()Ljava/net/URL;
    ...
    invoke-virtual {v7}, Lcom/bumptech/glide/load/p/g;->e()Ljava/util/Map;

    move-result-object v7

    invoke-direct {p0, v4, v5, v6, v7}, Lcom/bumptech/glide/load/n/j;->h(Ljava/net/URL;ILjava/net/URL;Ljava/util/Map;)Ljava/io/InputStream;

    move-result-object v4

    invoke-interface {p2, v4}, Lcom/bumptech/glide/load/n/d$a;->f(Ljava/lang/Object;)V
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    :cond_0
    invoke-interface {p2, v4}, Lcom/bumptech/glide/load/n/d$a;->c(Ljava/lang/Exception;)V
    :try_end_1
