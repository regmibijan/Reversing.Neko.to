...
.field private final g:Lcom/google/android/gms/common/api/internal/r;

.field protected final h:Lcom/google/android/gms/common/api/internal/g;
...
.method protected constructor <init>(Landroid/content/Context;Lcom/google/android/gms/common/api/a;Landroid/os/Looper;)V
    ...
    invoke-static {p1}, Lcom/google/android/gms/common/api/internal/g;->k(Landroid/content/Context;)Lcom/google/android/gms/common/api/internal/g;

    move-result-object p1

    iput-object p1, p0, Lcom/google/android/gms/common/api/e;->h:Lcom/google/android/gms/common/api/internal/g;

    invoke-virtual {p1}, Lcom/google/android/gms/common/api/internal/g;->n()I
    ...
    iput-object p1, p0, Lcom/google/android/gms/common/api/e;->g:Lcom/google/android/gms/common/api/internal/r;
...
.method private final s(ILcom/google/android/gms/common/api/internal/d;)Lcom/google/android/gms/common/api/internal/d;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<A::",
    ...
    iget-object v0, p0, Lcom/google/android/gms/common/api/e;->h:Lcom/google/android/gms/common/api/internal/g;
...
.method private final u(ILcom/google/android/gms/common/api/internal/s;)Lg/d/a/c/h/h;
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<TResult:",
    ...
    new-instance v6, Lg/d/a/c/h/i;

    invoke-direct {v6}, Lg/d/a/c/h/i;-><init>()V

    iget-object v0, p0, Lcom/google/android/gms/common/api/e;->h:Lcom/google/android/gms/common/api/internal/g;

    iget-object v5, p0, Lcom/google/android/gms/common/api/e;->g:Lcom/google/android/gms/common/api/internal/r;
    ...
    invoke-virtual/range {v0 .. v5}, Lcom/google/android/gms/common/api/internal/g;->i(Lcom/google/android/gms/common/api/e;ILcom/google/android/gms/common/api/internal/s;Lg/d/a/c/h/i;Lcom/google/android/gms/common/api/internal/r;)V

    invoke-virtual {v6}, Lg/d/a/c/h/i;->a()Lg/d/a/c/h/h;
...
.method protected d()Lcom/google/android/gms/common/internal/e$a;
    ...
    invoke-virtual {v1}, Lcom/google/android/gms/auth/api/signin/GoogleSignInAccount;->j()Landroid/accounts/Account;
...
.method public e(Lcom/google/android/gms/common/api/internal/s;)Lg/d/a/c/h/h;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<TResult:",
    ...
    invoke-direct {p0, v0, p1}, Lcom/google/android/gms/common/api/e;->u(ILcom/google/android/gms/common/api/internal/s;)Lg/d/a/c/h/h;
...
.method public f(Lcom/google/android/gms/common/api/internal/o;)Lg/d/a/c/h/h;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<A::",
    ...
    iget-object v0, p1, Lcom/google/android/gms/common/api/internal/o;->b:Lcom/google/android/gms/common/api/internal/t;

    invoke-virtual {v0}, Lcom/google/android/gms/common/api/internal/t;->a()Lcom/google/android/gms/common/api/internal/k$a;
    ...
    iget-object p1, p1, Lcom/google/android/gms/common/api/internal/o;->b:Lcom/google/android/gms/common/api/internal/t;

    invoke-virtual {v0, p0, v1, p1}, Lcom/google/android/gms/common/api/internal/g;->d(Lcom/google/android/gms/common/api/e;Lcom/google/android/gms/common/api/internal/n;Lcom/google/android/gms/common/api/internal/t;)Lg/d/a/c/h/h;
...
.method public g(Lcom/google/android/gms/common/api/internal/k$a;)Lg/d/a/c/h/h;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {v0, p0, p1}, Lcom/google/android/gms/common/api/internal/g;->c(Lcom/google/android/gms/common/api/e;Lcom/google/android/gms/common/api/internal/k$a;)Lg/d/a/c/h/h;
...
.method public h(Lcom/google/android/gms/common/api/internal/d;)Lcom/google/android/gms/common/api/internal/d;
    ...
    invoke-direct {p0, v0, p1}, Lcom/google/android/gms/common/api/e;->s(ILcom/google/android/gms/common/api/internal/d;)Lcom/google/android/gms/common/api/internal/d;

    return-object p1
.end method

.method public i(Lcom/google/android/gms/common/api/internal/s;)Lg/d/a/c/h/h;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<TResult:",
...
.method public final j()Lcom/google/android/gms/common/api/a;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
...
.method public q(Ljava/lang/Object;Ljava/lang/String;)Lcom/google/android/gms/common/api/internal/k;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<",
...
.method public r(Landroid/os/Looper;Lcom/google/android/gms/common/api/internal/g$a;)Lcom/google/android/gms/common/api/a$f;
    .locals 8
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public t(Landroid/content/Context;Landroid/os/Handler;)Lcom/google/android/gms/common/api/internal/t1;
    .locals 2
    ...
    invoke-direct {v0, p1, p2, v1}, Lcom/google/android/gms/common/api/internal/t1;-><init>(Landroid/content/Context;Landroid/os/Handler;Lcom/google/android/gms/common/internal/e;)V
