...
.method static a(Lorg/json/JSONObject;)Lcom/onesignal/p0;
    ...
    :try_start_0
    invoke-static {p0}, Lcom/onesignal/v;->g(Lorg/json/JSONObject;)Lorg/json/JSONObject;
    ...
    :try_start_1
    invoke-static {v0}, Lcom/onesignal/v;->q(Lcom/onesignal/p0;)V
    :try_end_1
    ...
    :goto_0
    :try_start_3
    invoke-static {v0, p0}, Lcom/onesignal/v;->r(Lcom/onesignal/p0;Lorg/json/JSONObject;)V
    :try_end_3
...
.method static b(Landroid/content/Context;Lcom/onesignal/j;Lcom/onesignal/x$a;)V
    .locals 5
    ...
    invoke-interface {p1, v1}, Lcom/onesignal/j;->h(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-interface {p1, v3, v4}, Lcom/onesignal/j;->b(Ljava/lang/String;Z)Z
    ...
    invoke-interface {p1, v3}, Lcom/onesignal/j;->e(Ljava/lang/String;)Ljava/lang/Long;
    ...
    invoke-static {v3}, Lcom/onesignal/v;->i(Lorg/json/JSONObject;)Ljava/lang/String;
    ...
    invoke-static {p0, v1}, Lcom/onesignal/d1;->I0(Landroid/content/Context;Lorg/json/JSONObject;)Z
    ...
    :cond_2
    invoke-interface {p1, v0}, Lcom/onesignal/j;->i(Ljava/lang/String;)Z
    ...
    :cond_3
    invoke-interface {p1, v0}, Lcom/onesignal/j;->g(Ljava/lang/String;)Ljava/lang/Integer;
    ...
    invoke-static {v2}, Lcom/onesignal/v;->c(Lcom/onesignal/y;)I
    ...
    invoke-static {p0}, Lcom/onesignal/a1;->B(I)V
    :try_end_0
...
.method static c(Lcom/onesignal/y;)I
    .locals 4

    invoke-static {}, Lcom/onesignal/d1;->S()Z
    ...
    invoke-static {p0}, Lcom/onesignal/v;->m(Lcom/onesignal/y;)V

    invoke-static {p0}, Lcom/onesignal/v;->t(Lcom/onesignal/y;)Z

    move-result v0

    if-eqz v0, :cond_1

    invoke-static {p0}, Lcom/onesignal/p;->r(Lcom/onesignal/y;)V
    ...
    invoke-static {p0, v2}, Lcom/onesignal/v;->n(Lcom/onesignal/y;Z)V
    ...
    invoke-static {v0, v1, v2}, Lcom/onesignal/d1;->q0(Lorg/json/JSONArray;ZZ)V
    :try_end_0
...
.method static synthetic d(Landroid/os/Bundle;)Lorg/json/JSONArray;
    .locals 0

    invoke-static {p0}, Lcom/onesignal/v;->f(Landroid/os/Bundle;)Lorg/json/JSONArray;
...
.method static e(Landroid/os/Bundle;)Lorg/json/JSONObject;
    .locals 7
    ...
    sget-object v4, Lcom/onesignal/d1$z;->e:Lcom/onesignal/d1$z;
    ...
    invoke-static {v4, v2, v3}, Lcom/onesignal/d1;->b(Lcom/onesignal/d1$z;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method private static f(Landroid/os/Bundle;)Lorg/json/JSONArray;
    .locals 1
    ...
    invoke-static {p0}, Lcom/onesignal/v;->e(Landroid/os/Bundle;)Lorg/json/JSONObject;
...
.method static g(Lorg/json/JSONObject;)Lorg/json/JSONObject;
    .locals 2
...
.method static h(Landroid/os/Bundle;)Z
    .locals 2

    const-string v0, "licon"

    invoke-static {p0, v0}, Lcom/onesignal/v;->j(Landroid/os/Bundle;Ljava/lang/String;)Z
...
.method static i(Lorg/json/JSONObject;)Ljava/lang/String;
    .locals 3
...
.method private static j(Landroid/os/Bundle;Ljava/lang/String;)Z
    .locals 1
...
.method static k(Lorg/json/JSONObject;)Lorg/json/JSONArray;
    .locals 1
...
.method static l(Landroid/content/Context;Landroid/os/Bundle;)Lcom/onesignal/v$b;
    .locals 4
    ...
    invoke-static {p1}, Lcom/onesignal/d1;->V(Landroid/os/Bundle;)Ljava/lang/String;
    ...
    invoke-static {p1}, Lcom/onesignal/v;->v(Landroid/os/Bundle;)V

    invoke-static {p1}, Lcom/onesignal/v;->e(Landroid/os/Bundle;)Lorg/json/JSONObject;

    move-result-object v2

    invoke-static {v2}, Lcom/onesignal/v;->i(Lorg/json/JSONObject;)Ljava/lang/String;
    ...
    invoke-virtual {p0, v3}, Lcom/onesignal/k0;->j(Ljava/lang/String;)V

    :cond_1
    return-object v0

    :cond_2
    invoke-static {p0, p1, v0}, Lcom/onesignal/v;->u(Landroid/content/Context;Landroid/os/Bundle;Lcom/onesignal/v$b;)Z
    ...
    :cond_3
    invoke-static {p0, v2}, Lcom/onesignal/d1;->I0(Landroid/content/Context;Lorg/json/JSONObject;)Z
    ...
    invoke-static {v2}, Lcom/onesignal/v;->s(Ljava/lang/String;)Z
    ...
    invoke-static {p0, p1, v1, v2}, Lcom/onesignal/v;->o(Landroid/content/Context;Landroid/os/Bundle;ZI)V
...
.method private static m(Lcom/onesignal/y;)V
    .locals 12
    ...
    :try_start_0
    invoke-virtual {v2}, Lcom/onesignal/j1;->c()Landroid/database/sqlite/SQLiteDatabase;
    ...
    invoke-virtual {p0, v0}, Lcom/onesignal/y;->h(Ljava/lang/Integer;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method static n(Lcom/onesignal/y;Z)V
    .locals 0

    invoke-static {p0, p1}, Lcom/onesignal/v;->p(Lcom/onesignal/y;Z)V

    invoke-virtual {p0}, Lcom/onesignal/y;->g()Z
    ...
    :cond_0
    invoke-virtual {p0}, Lcom/onesignal/y;->c()Ljava/lang/String;

    move-result-object p0

    invoke-static {p0}, Lcom/onesignal/w1;->k(Ljava/lang/String;)V

    invoke-static {}, Lcom/onesignal/t0;->a()Lcom/onesignal/t0;

    move-result-object p1

    invoke-virtual {p1, p0}, Lcom/onesignal/t0;->c(Ljava/lang/String;)V

    return-void
.end method

.method private static o(Landroid/content/Context;Landroid/os/Bundle;ZI)V
    .locals 1
    ...
    invoke-static {v0, p2}, Lcom/onesignal/v;->n(Lcom/onesignal/y;Z)V

    return-void
.end method

.method private static p(Lcom/onesignal/y;Z)V
    .locals 14
    ...
    :try_start_0
    invoke-static {v4}, Lcom/onesignal/v;->g(Lorg/json/JSONObject;)Lorg/json/JSONObject;

    move-result-object v5

    iget-object v6, p0, Lcom/onesignal/y;->a:Landroid/content/Context;

    invoke-static {v6}, Lcom/onesignal/j1;->b(Landroid/content/Context;)Lcom/onesignal/j1;
    ...
    :try_start_1
    invoke-virtual {v6}, Lcom/onesignal/j1;->d()Landroid/database/sqlite/SQLiteDatabase;
    ...
    invoke-static {v6, v3}, Lcom/onesignal/i;->c(Landroid/database/sqlite/SQLiteDatabase;Landroid/content/Context;)V
    ...
    :cond_4
    invoke-virtual {p0}, Lcom/onesignal/y;->e()Ljava/lang/CharSequence;
    ...
    :goto_1
    invoke-static {p1, v2, p0}, Lcom/onesignal/d1;->b(Lcom/onesignal/d1$z;Ljava/lang/String;Ljava/lang/Throwable;)V
    :try_end_5
    ...
    invoke-static {v0, v2, p1}, Lcom/onesignal/d1;->b(Lcom/onesignal/d1$z;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method private static q(Lcom/onesignal/p0;)V
    .locals 7
    .annotation system Ldalvik/annotation/Throws;
        value = {
    ...
    iput-object v2, p0, Lcom/onesignal/p0;->f:Ljava/util/List;
    ...
    iget-object v3, p0, Lcom/onesignal/p0;->f:Ljava/util/List;
...
.method private static r(Lcom/onesignal/p0;Lorg/json/JSONObject;)V
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/lang/Throwable;
    ...
    iput-object p1, p0, Lcom/onesignal/p0;->g:Lcom/onesignal/p0$b;

    const-string p1, "img"

    invoke-virtual {v0, p1}, Lorg/json/JSONObject;->optString(Ljava/lang/String;)Ljava/lang/String;

    iget-object p1, p0, Lcom/onesignal/p0;->g:Lcom/onesignal/p0$b;
    ...
    iget-object p0, p0, Lcom/onesignal/p0;->g:Lcom/onesignal/p0$b;
    ...
    iput-object p1, p0, Lcom/onesignal/p0$b;->b:Ljava/lang/String;
...
.method static s(Ljava/lang/String;)Z
    ...
    invoke-static {}, Lcom/onesignal/d1;->Y()Z
...
.method private static t(Lcom/onesignal/y;)Z
    .locals 3
    ...
    :cond_0
    invoke-virtual {p0}, Lcom/onesignal/y;->f()Z
    ...
    invoke-static {p0}, Lcom/onesignal/v;->s(Ljava/lang/String;)Z
...
.method private static u(Landroid/content/Context;Landroid/os/Bundle;Lcom/onesignal/v$b;)Z
    .locals 6

    invoke-static {p0}, Lcom/onesignal/x;->j(Landroid/content/Context;)Landroid/content/Intent;
    ...
    invoke-static {p0, p1, v2, v0, v1}, Lcom/onesignal/JobIntentService;->c(Landroid/content/Context;Landroid/content/ComponentName;ILandroid/content/Intent;Z)V
...
.method private static v(Landroid/os/Bundle;)V
    .locals 13
