...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Lcom/onesignal/p;->P(Lorg/json/JSONObject;Landroid/app/Activity;I)V
.end annotation
...
.method constructor <init>(Landroid/app/Activity;Lorg/json/JSONObject;I)V
    ...
    iput-object p1, p0, Lcom/onesignal/p$a;->c:Landroid/app/Activity;

    iput-object p2, p0, Lcom/onesignal/p$a;->d:Lorg/json/JSONObject;

    iput p3, p0, Lcom/onesignal/p$a;->e:I
...
.method public run()V
    ...
    iget-object v1, p0, Lcom/onesignal/p$a;->c:Landroid/app/Activity;

    invoke-direct {v0, v1}, Landroid/app/AlertDialog$Builder;-><init>(Landroid/content/Context;)V

    iget-object v1, p0, Lcom/onesignal/p$a;->d:Lorg/json/JSONObject;
    ...
    iget-object v3, p0, Lcom/onesignal/p$a;->c:Landroid/app/Activity;

    iget-object v4, p0, Lcom/onesignal/p$a;->d:Lorg/json/JSONObject;

    invoke-static {v3, v4, v1, v2}, Lcom/onesignal/p;->b(Landroid/content/Context;Lorg/json/JSONObject;Ljava/util/List;Ljava/util/List;)V

    iget v3, p0, Lcom/onesignal/p$a;->e:I

    invoke-static {v3}, Lcom/onesignal/p;->c(I)Landroid/content/Intent;
    ...
    :cond_0
    new-instance v4, Lcom/onesignal/p$a$a;

    invoke-direct {v4, p0, v2, v3}, Lcom/onesignal/p$a$a;-><init>(Lcom/onesignal/p$a;Ljava/util/List;Landroid/content/Intent;)V
