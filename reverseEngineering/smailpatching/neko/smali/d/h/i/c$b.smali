...
.method constructor <init>(C[F)V
    ...
    iput-char p1, p0, Ld/h/i/c$b;->a:C

    iput-object p2, p0, Ld/h/i/c$b;->b:[F

    return-void
.end method

.method constructor <init>(Ld/h/i/c$b;)V
    .locals 2

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iget-char v0, p1, Ld/h/i/c$b;->a:C

    iput-char v0, p0, Ld/h/i/c$b;->a:C

    iget-object p1, p1, Ld/h/i/c$b;->b:[F

    array-length v0, p1

    const/4 v1, 0x0

    invoke-static {p1, v1, v0}, Ld/h/i/c;->c([FII)[F

    move-result-object p1

    iput-object p1, p0, Ld/h/i/c$b;->b:[F
...
.method private static a(Landroid/graphics/Path;[FCC[F)V
    ...
    invoke-static/range {v0 .. v9}, Ld/h/i/c$b;->c(Landroid/graphics/Path;FFFFFFFZZ)V
...
.method private static c(Landroid/graphics/Path;FFFFFFFZZ)V
    ...
    invoke-static/range {v6 .. v24}, Ld/h/i/c$b;->b(Landroid/graphics/Path;DDDDDDDDD)V

    return-void
.end method

.method public static e([Ld/h/i/c$b;Landroid/graphics/Path;)V
    .locals 5
    ...
    invoke-static {p1, v0, v1, v3, v4}, Ld/h/i/c$b;->a(Landroid/graphics/Path;[FCC[F)V

    aget-object v1, p0, v2

    iget-char v1, v1, Ld/h/i/c$b;->a:C
...
# virtual methods
.method public d(Ld/h/i/c$b;Ld/h/i/c$b;F)V
    .locals 4
    ...
    :goto_0
    iget-object v1, p1, Ld/h/i/c$b;->b:[F

    array-length v2, v1

    if-ge v0, v2, :cond_0

    iget-object v2, p0, Ld/h/i/c$b;->b:[F
    ...
    iget-object v3, p2, Ld/h/i/c$b;->b:[F
