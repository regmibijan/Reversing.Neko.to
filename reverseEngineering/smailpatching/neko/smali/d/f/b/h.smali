...
.method public C(Ld/f/b/b;Z)V
    ...
    :cond_0
    iget-object v0, p1, Ld/f/b/b;->e:Ld/f/b/b$a;
    ...
    invoke-interface {v0, v2}, Ld/f/b/b$a;->b(I)Ld/f/b/i;

    move-result-object v3

    invoke-interface {v0, v2}, Ld/f/b/b$a;->d(I)F

    move-result v4

    iget-object v5, p0, Ld/f/b/h;->k:Ld/f/b/h$b;

    invoke-virtual {v5, v3}, Ld/f/b/h$b;->f(Ld/f/b/i;)V

    iget-object v5, p0, Ld/f/b/h;->k:Ld/f/b/h$b;

    invoke-virtual {v5, p2, v4}, Ld/f/b/h$b;->d(Ld/f/b/i;F)Z

    move-result v5

    if-eqz v5, :cond_1

    invoke-direct {p0, v3}, Ld/f/b/h;->F(Ld/f/b/i;)V

    :cond_1
    iget v3, p0, Ld/f/b/b;->b:F

    iget v5, p1, Ld/f/b/b;->b:F

    mul-float v5, v5, v4

    add-float/2addr v3, v5

    iput v3, p0, Ld/f/b/b;->b:F
    ...
    :cond_2
    invoke-direct {p0, p2}, Ld/f/b/h;->G(Ld/f/b/i;)V
...
.method public a(Ld/f/b/i;)V
    ...
    invoke-virtual {v0, p1}, Ld/f/b/h$b;->f(Ld/f/b/i;)V

    iget-object v0, p0, Ld/f/b/h;->k:Ld/f/b/h$b;

    invoke-virtual {v0}, Ld/f/b/h$b;->m()V
...
.method public b(Ld/f/b/d;[Z)Ld/f/b/i;
    ...
    invoke-virtual {v3, v2}, Ld/f/b/h$b;->f(Ld/f/b/i;)V

    iget-object v2, p0, Ld/f/b/h;->k:Ld/f/b/h$b;

    if-ne v1, p1, :cond_1

    invoke-virtual {v2}, Ld/f/b/h$b;->i()Z
    ...
    invoke-virtual {v2, v3}, Ld/f/b/h$b;->l(Ld/f/b/i;)Z
