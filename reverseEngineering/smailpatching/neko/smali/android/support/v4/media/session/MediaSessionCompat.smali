...
.method public constructor <init>(Landroid/content/Context;Ljava/lang/String;Landroid/content/ComponentName;Landroid/app/PendingIntent;Landroid/os/Bundle;Landroidx/versionedparcelable/d;)V
    ...
    invoke-static {p1}, Landroidx/media/j/a;->a(Landroid/content/Context;)Landroid/content/ComponentName;
    ...
    invoke-direct {p0, p1, p2, p5}, Landroid/support/v4/media/session/MediaSessionCompat;->b(Landroid/content/Context;Ljava/lang/String;Landroid/os/Bundle;)Landroid/media/session/MediaSession;
...
.method private b(Landroid/content/Context;Ljava/lang/String;Landroid/os/Bundle;)Landroid/media/session/MediaSession;
    .locals 2
...
.method static g(Landroid/support/v4/media/session/PlaybackStateCompat;Landroid/support/v4/media/MediaMetadataCompat;)Landroid/support/v4/media/session/PlaybackStateCompat;
    .locals 14
...
.method public p(Landroid/support/v4/media/session/PlaybackStateCompat;)V
    ...
    invoke-interface {v0, p1}, Landroid/support/v4/media/session/MediaSessionCompat$c;->p(Landroid/support/v4/media/session/PlaybackStateCompat;)V
...
.method public r(Landroidx/media/h;)V
    .locals 1
    ...
    invoke-interface {v0, p1}, Landroid/support/v4/media/session/MediaSessionCompat$c;->q(Landroidx/media/h;)V
