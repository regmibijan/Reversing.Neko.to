...
.method public f(Landroid/support/v4/media/session/MediaSessionCompat$b;Landroid/os/Handler;)V
    ...
    invoke-super {p0, p1, p2}, Landroid/support/v4/media/session/MediaSessionCompat$d;->f(Landroid/support/v4/media/session/MediaSessionCompat$b;Landroid/os/Handler;)V
...
.method t(Landroid/os/Bundle;)Landroid/media/RemoteControlClient$MetadataEditor;
    .locals 8

    invoke-super {p0, p1}, Landroid/support/v4/media/session/MediaSessionCompat$i;->t(Landroid/os/Bundle;)Landroid/media/RemoteControlClient$MetadataEditor;
...
.method w(J)I
    ...
    invoke-super {p0, p1, p2}, Landroid/support/v4/media/session/MediaSessionCompat$d;->w(J)I
