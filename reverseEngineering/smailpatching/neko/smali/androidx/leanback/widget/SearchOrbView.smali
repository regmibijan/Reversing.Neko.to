...
.field private h:Landroidx/leanback/widget/SearchOrbView$c;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    sget v0, Ld/n/a;->searchOrbViewStyle:I
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object v0, p0, Landroidx/leanback/widget/SearchOrbView;->q:Landroid/animation/ArgbEvaluator;
    ...
    iget-object v1, p0, Landroidx/leanback/widget/SearchOrbView;->d:Landroid/view/View;

    sget v2, Ld/n/f;->icon:I
    ...
    iput-object v1, p0, Landroidx/leanback/widget/SearchOrbView;->f:Landroid/widget/ImageView;

    invoke-virtual {p1}, Landroid/content/Context;->getResources()Landroid/content/res/Resources;

    move-result-object v1

    sget v2, Ld/n/e;->lb_search_orb_focused_zoom:I

    invoke-virtual {v1, v2, v3, v3}, Landroid/content/res/Resources;->getFraction(III)F

    move-result v1

    iput v1, p0, Landroidx/leanback/widget/SearchOrbView;->i:F

    invoke-virtual {p1}, Landroid/content/Context;->getResources()Landroid/content/res/Resources;

    move-result-object v1

    sget v2, Ld/n/g;->lb_search_orb_pulse_duration_ms:I
    ...
    sget v2, Ld/n/g;->lb_search_orb_scale_duration_ms:I

    invoke-virtual {v1, v2}, Landroid/content/res/Resources;->getInteger(I)I

    move-result v1

    iput v1, p0, Landroidx/leanback/widget/SearchOrbView;->k:I

    invoke-virtual {p1}, Landroid/content/Context;->getResources()Landroid/content/res/Resources;

    move-result-object v1

    sget v2, Ld/n/c;->lb_search_orb_focused_z:I
    ...
    iput v1, p0, Landroidx/leanback/widget/SearchOrbView;->m:F

    invoke-virtual {p1}, Landroid/content/Context;->getResources()Landroid/content/res/Resources;

    move-result-object v1

    sget v2, Ld/n/c;->lb_search_orb_unfocused_z:I
    ...
    sget-object v1, Ld/n/l;->lbSearchOrbView:[I
    ...
    sget p2, Ld/n/l;->lbSearchOrbView_searchOrbIcon:I
    ...
    sget p2, Ld/n/d;->lb_ic_in_app_search:I
    ...
    sget p2, Ld/n/b;->lb_default_search_color:I

    invoke-virtual {v0, p2}, Landroid/content/res/Resources;->getColor(I)I

    move-result p2

    sget p3, Ld/n/l;->lbSearchOrbView_searchOrbColor:I

    invoke-virtual {p1, p3, p2}, Landroid/content/res/TypedArray;->getColor(II)I

    move-result p2

    sget p3, Ld/n/l;->lbSearchOrbView_searchOrbBrightColor:I

    invoke-virtual {p1, p3, p2}, Landroid/content/res/TypedArray;->getColor(II)I

    move-result p3

    sget v0, Ld/n/l;->lbSearchOrbView_searchOrbIconColor:I
    ...
    iget-object p1, p0, Landroidx/leanback/widget/SearchOrbView;->f:Landroid/widget/ImageView;

    iget p2, p0, Landroidx/leanback/widget/SearchOrbView;->m:F

    invoke-static {p1, p2}, Ld/h/q/v;->E0(Landroid/view/View;F)V
...
.method private d(ZI)V
    ...
    iget-object v0, p0, Landroidx/leanback/widget/SearchOrbView;->s:Landroid/animation/ValueAnimator;
    ...
    iput-object v0, p0, Landroidx/leanback/widget/SearchOrbView;->s:Landroid/animation/ValueAnimator;
    ...
    iget-object p1, p0, Landroidx/leanback/widget/SearchOrbView;->s:Landroid/animation/ValueAnimator;
...
.method private e()V
    ...
    iget-boolean v0, p0, Landroidx/leanback/widget/SearchOrbView;->p:Z

    if-eqz v0, :cond_1

    iget-object v0, p0, Landroidx/leanback/widget/SearchOrbView;->q:Landroid/animation/ArgbEvaluator;
    ...
    iget-object v3, p0, Landroidx/leanback/widget/SearchOrbView;->h:Landroidx/leanback/widget/SearchOrbView$c;
    ...
    iget-object v2, p0, Landroidx/leanback/widget/SearchOrbView;->h:Landroidx/leanback/widget/SearchOrbView$c;
...
.method a(Z)V
    ...
    iget v1, p0, Landroidx/leanback/widget/SearchOrbView;->k:I
    ...
    iget v0, p0, Landroidx/leanback/widget/SearchOrbView;->k:I
...
.method public b(Z)V
    ...
    iput-boolean p1, p0, Landroidx/leanback/widget/SearchOrbView;->o:Z
...
.method c(F)V
    ...
    iget-object v0, p0, Landroidx/leanback/widget/SearchOrbView;->e:Landroid/view/View;
...
.method getLayoutResourceId()I
    ...
    sget v0, Ld/n/h;->lb_search_orb:I
...
.method public getOrbColor()I
    ...
    iget-object v0, p0, Landroidx/leanback/widget/SearchOrbView;->h:Landroidx/leanback/widget/SearchOrbView$c;
...
.method public getOrbIcon()Landroid/graphics/drawable/Drawable;
    ...
    iget-object v0, p0, Landroidx/leanback/widget/SearchOrbView;->g:Landroid/graphics/drawable/Drawable;
...
.method protected onAttachedToWindow()V
    ...
    iput-boolean v0, p0, Landroidx/leanback/widget/SearchOrbView;->p:Z
...
.method public onClick(Landroid/view/View;)V
    ...
    iget-object v0, p0, Landroidx/leanback/widget/SearchOrbView;->c:Landroid/view/View$OnClickListener;
...
.method public setOnOrbClickedListener(Landroid/view/View$OnClickListener;)V
    ...
    iput-object p1, p0, Landroidx/leanback/widget/SearchOrbView;->c:Landroid/view/View$OnClickListener;
...
.method public setOrbColors(Landroidx/leanback/widget/SearchOrbView$c;)V
    ...
    iput-object p1, p0, Landroidx/leanback/widget/SearchOrbView;->h:Landroidx/leanback/widget/SearchOrbView$c;

    iget-object v0, p0, Landroidx/leanback/widget/SearchOrbView;->f:Landroid/widget/ImageView;

    iget p1, p1, Landroidx/leanback/widget/SearchOrbView$c;->c:I

    invoke-virtual {v0, p1}, Landroid/widget/ImageView;->setColorFilter(I)V

    iget-object p1, p0, Landroidx/leanback/widget/SearchOrbView;->n:Landroid/animation/ValueAnimator;

    if-nez p1, :cond_0

    iget-object p1, p0, Landroidx/leanback/widget/SearchOrbView;->h:Landroidx/leanback/widget/SearchOrbView$c;
...
.method public setOrbIcon(Landroid/graphics/drawable/Drawable;)V
    ...
    iput-object p1, p0, Landroidx/leanback/widget/SearchOrbView;->g:Landroid/graphics/drawable/Drawable;
...
.method setSearchOrbZ(F)V
    ...
    iget v1, p0, Landroidx/leanback/widget/SearchOrbView;->l:F

    iget v2, p0, Landroidx/leanback/widget/SearchOrbView;->m:F
    ...
    invoke-static {v0, v1}, Ld/h/q/v;->E0(Landroid/view/View;F)V
