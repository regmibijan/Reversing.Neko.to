...
.field static final h:Landroidx/leanback/transition/FadeAndShortSlide$g;

.field static final i:Landroidx/leanback/transition/FadeAndShortSlide$g;
...
# instance fields
.field private c:Landroidx/leanback/transition/FadeAndShortSlide$g;

.field private d:Landroid/transition/Visibility;

.field private e:F

.field final f:Landroidx/leanback/transition/FadeAndShortSlide$g;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroidx/leanback/transition/FadeAndShortSlide;->g:Landroid/animation/TimeInterpolator;
...
.method public constructor <init>(I)V
    ...
    iput-object v0, p0, Landroidx/leanback/transition/FadeAndShortSlide;->d:Landroid/transition/Visibility;

    const/high16 v0, -0x40800000    # -1.0f

    iput v0, p0, Landroidx/leanback/transition/FadeAndShortSlide;->e:F
    ...
    iput-object v0, p0, Landroidx/leanback/transition/FadeAndShortSlide;->f:Landroidx/leanback/transition/FadeAndShortSlide$g;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    sget-object v0, Ld/n/l;->lbSlide:[I

    invoke-virtual {p1, p2, v0}, Landroid/content/Context;->obtainStyledAttributes(Landroid/util/AttributeSet;[I)Landroid/content/res/TypedArray;

    move-result-object p1

    sget p2, Ld/n/l;->lbSlide_lb_slideEdge:I
...
.method private b(Landroid/transition/TransitionValues;)V
    .locals 2
...
.method public addListener(Landroid/transition/Transition$TransitionListener;)Landroid/transition/Transition;
    ...
    iget-object v0, p0, Landroidx/leanback/transition/FadeAndShortSlide;->d:Landroid/transition/Visibility;
...
.method c(Landroid/view/ViewGroup;)F
    ...
    iget v0, p0, Landroidx/leanback/transition/FadeAndShortSlide;->e:F
...
.method public captureEndValues(Landroid/transition/TransitionValues;)V
    ...
    invoke-direct {p0, p1}, Landroidx/leanback/transition/FadeAndShortSlide;->b(Landroid/transition/TransitionValues;)V
...
.method public clone()Landroid/transition/Transition;
    ...
    iget-object v1, p0, Landroidx/leanback/transition/FadeAndShortSlide;->d:Landroid/transition/Visibility;
    ...
    iput-object v1, v0, Landroidx/leanback/transition/FadeAndShortSlide;->d:Landroid/transition/Visibility;
...
.method public e(I)V
    ...
    :cond_3
    iget-object p1, p0, Landroidx/leanback/transition/FadeAndShortSlide;->f:Landroidx/leanback/transition/FadeAndShortSlide$g;
    ...
    :goto_0
    iput-object p1, p0, Landroidx/leanback/transition/FadeAndShortSlide;->c:Landroidx/leanback/transition/FadeAndShortSlide$g;
...
.method public onAppear(Landroid/view/ViewGroup;Landroid/view/View;Landroid/transition/TransitionValues;Landroid/transition/TransitionValues;)Landroid/animation/Animator;
    ...
    iget-object v1, v10, Landroidx/leanback/transition/FadeAndShortSlide;->c:Landroidx/leanback/transition/FadeAndShortSlide$g;
    ...
    sget-object v8, Landroidx/leanback/transition/FadeAndShortSlide;->g:Landroid/animation/TimeInterpolator;
    ...
    iget-object v1, v10, Landroidx/leanback/transition/FadeAndShortSlide;->d:Landroid/transition/Visibility;
