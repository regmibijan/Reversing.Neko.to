...
.method private a()Landroidx/appcompat/view/menu/k;
    ...
    sget v2, Ld/a/d;->abc_cascading_menus_min_smallest_width:I
    ...
    invoke-virtual {v0, v1}, Landroidx/appcompat/view/menu/k;->d(Landroidx/appcompat/view/menu/g;)V
    ...
    invoke-virtual {v0, v1}, Landroidx/appcompat/view/menu/k;->h(Landroid/view/View;)V

    iget-object v1, p0, Landroidx/appcompat/view/menu/l;->i:Landroidx/appcompat/view/menu/m$a;

    invoke-interface {v0, v1}, Landroidx/appcompat/view/menu/m;->w(Landroidx/appcompat/view/menu/m$a;)V
...
.method private l(IIZZ)V
    ...
    invoke-static {p4}, Ld/h/q/v;->C(Landroid/view/View;)I

    move-result p4

    invoke-static {p3, p4}, Ld/h/q/e;->b(II)I
    ...
    invoke-virtual {v0, p4}, Landroidx/appcompat/view/menu/k;->i(Landroid/graphics/Rect;)V

    :cond_1
    invoke-interface {v0}, Landroidx/appcompat/view/menu/p;->b()V
...
.method public j(Landroidx/appcompat/view/menu/m$a;)V
    ...
    invoke-interface {v0, p1}, Landroidx/appcompat/view/menu/m;->w(Landroidx/appcompat/view/menu/m$a;)V
