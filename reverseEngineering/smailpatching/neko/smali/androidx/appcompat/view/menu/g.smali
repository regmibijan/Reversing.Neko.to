...
.method private a0(ILjava/lang/CharSequence;ILandroid/graphics/drawable/Drawable;Landroid/view/View;)V
    ...
    invoke-static {p1, p3}, Ld/h/h/a;->f(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
...
.method private f0(Z)V
    ...
    invoke-static {p1, v1}, Ld/h/q/w;->f(Landroid/view/ViewConfiguration;Landroid/content/Context;)Z
...
.method private i(Z)V
    ...
    :cond_1
    invoke-interface {v2, p1}, Landroidx/appcompat/view/menu/m;->s(Z)V
...
.method private j(Landroid/os/Bundle;)V
    ...
    :cond_2
    invoke-interface {v2}, Landroidx/appcompat/view/menu/m;->r()I
    ...
    invoke-interface {v2, v1}, Landroidx/appcompat/view/menu/m;->y(Landroid/os/Parcelable;)V
...
.method private k(Landroid/os/Bundle;)V
    ...
    :cond_2
    invoke-interface {v3}, Landroidx/appcompat/view/menu/m;->r()I

    move-result v2

    if-lez v2, :cond_1

    invoke-interface {v3}, Landroidx/appcompat/view/menu/m;->A()Landroid/os/Parcelable;
...
.method private l(Landroidx/appcompat/view/menu/r;Landroidx/appcompat/view/menu/m;)Z
    ...
    invoke-interface {p2, p1}, Landroidx/appcompat/view/menu/m;->z(Landroidx/appcompat/view/menu/r;)Z
    ...
    invoke-interface {v2, p1}, Landroidx/appcompat/view/menu/m;->z(Landroidx/appcompat/view/menu/r;)Z
...
.method public O(Landroid/view/MenuItem;Landroidx/appcompat/view/menu/m;I)Z
    ...
    invoke-virtual {p1}, Landroidx/appcompat/view/menu/i;->b()Ld/h/q/b;
    ...
    invoke-virtual {v2}, Ld/h/q/b;->b()Z
    ...
    invoke-virtual {v2, p1}, Ld/h/q/b;->g(Landroid/view/SubMenu;)V
...
.method public c(Landroidx/appcompat/view/menu/m;Landroid/content/Context;)V
    ...
    invoke-interface {p1, p2, p0}, Landroidx/appcompat/view/menu/m;->x(Landroid/content/Context;Landroidx/appcompat/view/menu/g;)V
...
.method public f(Landroidx/appcompat/view/menu/i;)Z
    ...
    :cond_2
    invoke-interface {v3, p0, p1}, Landroidx/appcompat/view/menu/m;->u(Landroidx/appcompat/view/menu/g;Landroidx/appcompat/view/menu/i;)Z
...
.method public m(Landroidx/appcompat/view/menu/i;)Z
    ...
    :cond_2
    invoke-interface {v3, p0, p1}, Landroidx/appcompat/view/menu/m;->v(Landroidx/appcompat/view/menu/g;Landroidx/appcompat/view/menu/i;)Z
...
.method public t()V
    ...
    :cond_1
    invoke-interface {v5}, Landroidx/appcompat/view/menu/m;->t()Z
