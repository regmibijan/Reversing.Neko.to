...
.method public constructor <init>(Landroidx/appcompat/widget/v;Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-virtual {p0, p1}, Landroidx/appcompat/widget/i0;->D(Landroid/view/View;)V

    const/4 p2, 0x1

    invoke-virtual {p0, p2}, Landroidx/appcompat/widget/i0;->J(Z)V

    const/4 p2, 0x0

    invoke-virtual {p0, p2}, Landroidx/appcompat/widget/i0;->O(I)V
    ...
    invoke-virtual {p0, p2}, Landroidx/appcompat/widget/i0;->L(Landroid/widget/AdapterView$OnItemClickListener;)V

    return-void
.end method

.method static synthetic R(Landroidx/appcompat/widget/v$e;)V
    .locals 0
...
.method S()V
    ...
    invoke-virtual {p0}, Landroidx/appcompat/widget/i0;->i()Landroid/graphics/drawable/Drawable;
    ...
    iget-object v1, v1, Landroidx/appcompat/widget/v;->j:Landroid/graphics/Rect;
    ...
    iget-object v0, v0, Landroidx/appcompat/widget/v;->j:Landroid/graphics/Rect;
    ...
    iget v5, v4, Landroidx/appcompat/widget/v;->i:I
    ...
    iget-object v6, v6, Landroidx/appcompat/widget/v;->j:Landroid/graphics/Rect;
    ...
    :goto_2
    invoke-virtual {p0, v4}, Landroidx/appcompat/widget/i0;->F(I)V

    goto :goto_3

    :cond_4
    invoke-virtual {p0, v5}, Landroidx/appcompat/widget/i0;->F(I)V
    ...
    invoke-virtual {p0}, Landroidx/appcompat/widget/i0;->z()I

    move-result v0

    sub-int/2addr v3, v0

    invoke-virtual {p0}, Landroidx/appcompat/widget/v$e;->T()I
...
.method public n(II)V
    ...
    invoke-virtual {p0}, Landroidx/appcompat/widget/v$e;->S()V
    ...
    invoke-virtual {p0, p1}, Landroidx/appcompat/widget/i0;->P(I)V
    ...
    invoke-virtual {p0, p1}, Landroidx/appcompat/widget/i0;->K(Landroid/widget/PopupWindow$OnDismissListener;)V
