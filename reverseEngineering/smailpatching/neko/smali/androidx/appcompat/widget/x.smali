...
.method private B(Landroid/content/Context;Landroidx/appcompat/widget/v0;)V
    ...
    sget v0, Ld/a/j;->TextAppearance_android_textFontWeight:I
    ...
    invoke-virtual {p2, v0, p1, v8}, Landroidx/appcompat/widget/v0;->j(IILd/h/h/d/f$a;)Landroid/graphics/Typeface;
...
.method m(Landroid/util/AttributeSet;I)V
    ...
    sget-object v0, Ld/a/j;->AppCompatTextHelper:[I
    ...
    sget-object v2, Ld/a/j;->AppCompatTextHelper:[I
    ...
    invoke-static/range {v0 .. v6}, Ld/h/q/v;->l0(Landroid/view/View;Landroid/content/Context;[ILandroid/util/AttributeSet;Landroid/content/res/TypedArray;II)V
    ...
    sget v1, Ld/a/j;->AppCompatTextHelper_android_drawableLeft:I
    ...
    :cond_0
    sget v1, Ld/a/j;->AppCompatTextHelper_android_drawableTop:I
    ...
    :cond_1
    sget v1, Ld/a/j;->AppCompatTextHelper_android_drawableRight:I
    ...
    :cond_2
    sget v1, Ld/a/j;->AppCompatTextHelper_android_drawableBottom:I
    ...
    sget v1, Ld/a/j;->AppCompatTextHelper_android_drawableStart:I
    ...
    iput-object v1, v7, Landroidx/appcompat/widget/x;->f:Landroidx/appcompat/widget/t0;

    :cond_4
    sget v1, Ld/a/j;->AppCompatTextHelper_android_drawableEnd:I
    ...
    iput-object v1, v7, Landroidx/appcompat/widget/x;->g:Landroidx/appcompat/widget/t0;
    ...
    invoke-static {v10, v0, v5}, Landroidx/appcompat/widget/v0;->t(Landroid/content/Context;I[I)Landroidx/appcompat/widget/v0;

    move-result-object v0

    if-nez v1, :cond_6

    sget v5, Ld/a/j;->TextAppearance_textAllCaps:I
    ...
    invoke-virtual {v0, v5, v12}, Landroidx/appcompat/widget/v0;->a(IZ)Z
    ...
    sget v15, Ld/a/j;->TextAppearance_android_textColor:I

    invoke-virtual {v0, v15}, Landroidx/appcompat/widget/v0;->s(I)Z
    ...
    invoke-virtual {v0, v15}, Landroidx/appcompat/widget/v0;->c(I)Landroid/content/res/ColorStateList;
    ...
    :goto_1
    sget v3, Ld/a/j;->TextAppearance_android_textColorHint:I
    ...
    :goto_2
    sget v13, Ld/a/j;->TextAppearance_android_textColorLink:I
    ...
    :goto_3
    sget v14, Ld/a/j;->TextAppearance_textLocale:I
    ...
    invoke-virtual {v0, v14}, Landroidx/appcompat/widget/v0;->o(I)Ljava/lang/String;
    ...
    sget v4, Ld/a/j;->TextAppearance_fontVariationSettings:I
    ...
    invoke-virtual {v0, v4}, Landroidx/appcompat/widget/v0;->o(I)Ljava/lang/String;
    ...
    sget v2, Ld/a/j;->TextAppearance_textAllCaps:I

    invoke-virtual {v0, v2}, Landroidx/appcompat/widget/v0;->s(I)Z
    ...
    invoke-virtual {v0, v2, v12}, Landroidx/appcompat/widget/v0;->a(IZ)Z
    ...
    invoke-virtual {v0, v2}, Landroidx/appcompat/widget/v0;->c(I)Landroid/content/res/ColorStateList;

    move-result-object v15

    :cond_f
    sget v2, Ld/a/j;->TextAppearance_android_textColorHint:I
    ...
    :cond_10
    sget v2, Ld/a/j;->TextAppearance_android_textColorLink:I
    ...
    :cond_11
    sget v2, Ld/a/j;->TextAppearance_textLocale:I
    ...
    invoke-virtual {v0, v2}, Landroidx/appcompat/widget/v0;->o(I)Ljava/lang/String;
    ...
    sget v2, Ld/a/j;->TextAppearance_fontVariationSettings:I
    ...
    invoke-virtual {v0, v2, v6}, Landroidx/appcompat/widget/v0;->f(II)I
    ...
    :cond_1f
    :goto_a
    sget-object v0, Ld/a/j;->AppCompatTextView:[I

    invoke-static {v10, v8, v0}, Landroidx/appcompat/widget/v0;->u(Landroid/content/Context;Landroid/util/AttributeSet;[I)Landroidx/appcompat/widget/v0;

    move-result-object v8

    sget v0, Ld/a/j;->AppCompatTextView_drawableLeftCompat:I
    ...
    :goto_b
    sget v0, Ld/a/j;->AppCompatTextView_drawableTopCompat:I
    ...
    :goto_c
    sget v0, Ld/a/j;->AppCompatTextView_drawableRightCompat:I
    ...
    :goto_d
    sget v0, Ld/a/j;->AppCompatTextView_drawableBottomCompat:I
    ...
    :goto_e
    sget v0, Ld/a/j;->AppCompatTextView_drawableStartCompat:I
    ...
    :goto_f
    sget v0, Ld/a/j;->AppCompatTextView_drawableEndCompat:I
    ...
    sget v0, Ld/a/j;->AppCompatTextView_drawableTint:I
    ...
    invoke-static {v1, v0}, Landroidx/core/widget/j;->j(Landroid/widget/TextView;Landroid/content/res/ColorStateList;)V

    :cond_26
    sget v0, Ld/a/j;->AppCompatTextView_drawableTintMode:I
    ...
    invoke-static {v2, v0}, Landroidx/core/widget/j;->k(Landroid/widget/TextView;Landroid/graphics/PorterDuff$Mode;)V
    ...
    :goto_11
    sget v0, Ld/a/j;->AppCompatTextView_firstBaselineToTopHeight:I

    invoke-virtual {v8, v0, v1}, Landroidx/appcompat/widget/v0;->f(II)I

    move-result v0

    sget v2, Ld/a/j;->AppCompatTextView_lastBaselineToBottomHeight:I

    invoke-virtual {v8, v2, v1}, Landroidx/appcompat/widget/v0;->f(II)I

    move-result v2

    sget v3, Ld/a/j;->AppCompatTextView_lineHeight:I
    ...
    invoke-static {v4, v0}, Landroidx/core/widget/j;->m(Landroid/widget/TextView;I)V
    ...
    invoke-static {v0, v2}, Landroidx/core/widget/j;->n(Landroid/widget/TextView;I)V
    ...
    invoke-static {v0, v3}, Landroidx/core/widget/j;->o(Landroid/widget/TextView;I)V
...
.method q(Landroid/content/Context;I)V
    ...
    sget v0, Ld/a/j;->TextAppearance_textAllCaps:I
    ...
    sget v0, Ld/a/j;->TextAppearance_android_textColor:I
    ...
    :cond_1
    sget v0, Ld/a/j;->TextAppearance_android_textColorLink:I
    ...
    :cond_2
    sget v0, Ld/a/j;->TextAppearance_android_textColorHint:I
    ...
    :cond_3
    sget v0, Ld/a/j;->TextAppearance_android_textSize:I
    ...
    sget p1, Ld/a/j;->TextAppearance_fontVariationSettings:I
